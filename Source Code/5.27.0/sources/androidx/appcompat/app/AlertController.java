        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    anonymousClass1 = new CursorAdapter(this.mContext, cursor, false) {
                ...
                if (cursor2 != null) {
                    ListAdapter simpleCursorAdapter = new SimpleCursorAdapter(this.mContext, i2, cursor2, new String[]{this.mLabelColumn}, new int[]{16908308});
                } else {
