...
public class CardView2 extends FrameLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public void setShadowPadding(int i, int i2, int i3, int i4) {
            ...
            CardView2 cardView2 = CardView2.this;
            super.setPadding(i + cardView2.mContentPadding.left, i2 + CardView2.this.mContentPadding.top, i3 + CardView2.this.mContentPadding.right, i4 + CardView2.this.mContentPadding.bottom);
        }
