...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        ...
        if (VERSION.SDK_INT >= 19) {
            ...
            try {
                if (((Integer) Class.forName(AppOpsManager.class.getName()).getMethod(CHECK_OP_NO_THROW, new Class[]{Integer.TYPE, Integer.TYPE, String.class}).invoke(appOpsManager, new Object[]{Integer.valueOf(((Integer) r4.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(i), packageName})).intValue() != 0) {
                    z = false;
                }
