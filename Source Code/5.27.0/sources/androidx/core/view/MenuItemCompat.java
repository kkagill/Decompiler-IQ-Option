...
public final class MenuItemCompat {
    ...
    public static CharSequence getContentDescription(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getContentDescription() : null;
    }
    ...
    public static CharSequence getTooltipText(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getTooltipText() : null;
    }
    ...
    public static int getNumericModifiers(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getNumericModifiers() : 0;
    }
    ...
    public static int getAlphabeticModifiers(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getAlphabeticModifiers() : 0;
    }
    ...
    public static ColorStateList getIconTintList(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getIconTintList() : null;
    }
    ...
    public static Mode getIconTintMode(MenuItem menuItem) {
        ...
        return VERSION.SDK_INT >= 26 ? menuItem.getIconTintMode() : null;
    }
