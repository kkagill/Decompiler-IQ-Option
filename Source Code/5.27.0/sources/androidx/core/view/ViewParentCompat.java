...
public final class ViewParentCompat {
    ...
    public static boolean onStartNestedScroll(ViewParent viewParent, View view, View view2, int i, int i2) {
        ...
        if (i2 == 0) {
            if (VERSION.SDK_INT >= 21) {
                ...
                return ((NestedScrollingParent) viewParent2).onStartNestedScroll(view, view2, i);
            }
        }
        return false;
    }
    ...
    public static boolean onNestedFling(ViewParent viewParent, View view, float f, float f2, boolean z) {
        if (VERSION.SDK_INT >= 21) {
            ...
            if (viewParent2 instanceof NestedScrollingParent) {
                return ((NestedScrollingParent) viewParent2).onNestedFling(view, f, f2, z);
            }
            return false;
        }
    }
    ...
    public static boolean onNestedPreFling(ViewParent viewParent, View view, float f, float f2) {
        if (VERSION.SDK_INT >= 21) {
            ...
            if (viewParent2 instanceof NestedScrollingParent) {
                return ((NestedScrollingParent) viewParent2).onNestedPreFling(view, f, f2);
            }
            return false;
        }
    }
