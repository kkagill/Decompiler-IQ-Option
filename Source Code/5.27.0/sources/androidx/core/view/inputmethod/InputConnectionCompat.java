...
public final class InputConnectionCompat {
    ...
    static boolean handlePerformPrivateCommand(@androidx.annotation.Nullable java.lang.String r7, @androidx.annotation.NonNull android.os.Bundle r8, @androidx.annotation.NonNull androidx.core.view.inputmethod.InputConnectionCompat.OnCommitContentListener r9) {
        /*
        r0 = "androidx.core.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT";
    ...
    L_0x000d:
        r7 = 0;
        r1 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER";
        r1 = r8.getParcelable(r1);	 Catch:{ all -> 0x004d }
        r1 = (android.os.ResultReceiver) r1;	 Catch:{ all -> 0x004d }
        r2 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_URI";
        r2 = r8.getParcelable(r2);	 Catch:{ all -> 0x004b }
        r2 = (android.net.Uri) r2;	 Catch:{ all -> 0x004b }
        r3 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION";
        r3 = r8.getParcelable(r3);	 Catch:{ all -> 0x004b }
        r3 = (android.content.ClipDescription) r3;	 Catch:{ all -> 0x004b }
        r4 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI";
        r4 = r8.getParcelable(r4);	 Catch:{ all -> 0x004b }
        r4 = (android.net.Uri) r4;	 Catch:{ all -> 0x004b }
        r5 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS";
        r5 = r8.getInt(r5);	 Catch:{ all -> 0x004b }
        r6 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_OPTS";
