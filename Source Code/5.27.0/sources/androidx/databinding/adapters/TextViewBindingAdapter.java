...
public class TextViewBindingAdapter {
    ...
    L_0x0051:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.databinding.adapters.TextViewBindingAdapter.setMaxLength(android.widget.TextView, int):void");
    }
    ...
    public static void setTextWatcher(TextView textView, final BeforeTextChanged beforeTextChanged, final OnTextChanged onTextChanged, final AfterTextChanged afterTextChanged, final InverseBindingListener inverseBindingListener) {
        ...
        TextWatcher textWatcher = (TextWatcher) ListenerUtil.trackListener(textView, obj, R.id.textWatcher);
        if (textWatcher != null) {
