...
public final class PrintHelper {
            ...
            if (cancellationSignal.isCanceled()) {
                ...
                this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                    ...
                    public void onPostExecute(Bitmap bitmap) {
                        ...
                        if (bitmap != null) {
                            layoutResultCallback2.onLayoutFinished(new Builder(printUriAdapter.mJobName).setContentType(1).setPageCount(1).build(), 1 ^ printAttributes3.equals(printAttributes4));
                        } else {
     ...
     */
            ...
            L_0x000a:
                ...
                r1 = androidx.print.PrintHelper.this;	 Catch:{ Throwable -> 0x00e2 }
                ...
                r1 = androidx.print.PrintHelper.convertBitmapForColorMode(r1, r2);	 Catch:{ Throwable -> 0x00e2 }
            ...
            L_0x002a:
                ...
                r4 = androidx.print.PrintHelper.IS_MIN_MARGINS_HANDLING_CORRECT;	 Catch:{ all -> 0x00cd }
            ...
            L_0x0041:
                ...
                r5 = androidx.print.PrintHelper.this;	 Catch:{ all -> 0x00cd }
            ...
            L_0x0064:
                ...
                r4 = androidx.print.PrintHelper.getMatrix(r4, r5, r2, r6);	 Catch:{ all -> 0x00cd }
                r5 = androidx.print.PrintHelper.IS_MIN_MARGINS_HANDLING_CORRECT;	 Catch:{ all -> 0x00cd }
