...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void draw(Canvas canvas, Rect rect) {
            ...
            f = this.mRotation;
            f3 = (f3 + f) * 360.0f;
            float f4 = ((this.mEndTrim + f) * 360.0f) - f3;
    ...
    public void applyTransformation(float f, Ring ring, boolean z) {
        if (this.mFinishing) {
            ...
            if (f < 0.5f) {
                ...
                startingStartTrim = ((MATERIAL_INTERPOLATOR.getInterpolation(f2) * 0.79f) + MIN_PROGRESS_ARC) + startingStartTrim;
                f2 = f3;
            } else {
            ...
            startingRotation += RING_ROTATION * f;
            f = (f + this.mRotationCount) * GROUP_FULL_ROTATION;
