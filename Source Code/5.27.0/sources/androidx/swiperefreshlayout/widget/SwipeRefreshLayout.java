...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (getChildCount() != 0) {
            ...
            if (view != null) {
                ...
                i2 = this.mCircleView.getMeasuredHeight();
                CircleImageView circleImageView = this.mCircleView;
                measuredWidth /= 2;
                i /= 2;
                i4 = measuredWidth - i;
                int i5 = this.mCurrentTargetOffsetTop;
                circleImageView.layout(i4, i5, measuredWidth + i, i2 + i5);
            }
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    actionMasked = this.mActivePointerId;
                    if (actionMasked == -1) {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setProgressRotation((((max * 0.4f) - 16.0f) + (abs * DECELERATE_INTERPOLATION_FACTOR)) * 0.5f);
    ...
    private void startDragging(float f) {
        ...
        if (f > ((float) i) && !this.mIsBeingDragged) {
