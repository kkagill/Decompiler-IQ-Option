...
public class HitBuilders {
    ...
    public static class HitBuilder<T extends HitBuilder> {
        ...
        public Map<String, String> build() {
            ...
            for (Entry entry : this.zzry.entrySet()) {
                ...
                if (!TextUtils.isEmpty((CharSequence) entry.getKey())) {
                    ...
                    zzm = "nm";
                    hashMap.put(zzm.length() != 0 ? valueOf3.concat(zzm) : new String(valueOf3), (String) entry.getKey());
                }
                i++;
            }
            return hashMap;
        ...
        public T addImpression(Product product, String str) {
            ...
            ((List) this.zzry.get(str2)).add(product);
            return this;
        }
