...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public IdToken(@Param(id = 1) @NonNull String str, @Param(id = 2) @NonNull String str2) {
        Preconditions.checkArgument(TextUtils.isEmpty(str) ^ 1, "account type string cannot be null or empty");
        Preconditions.checkArgument(TextUtils.isEmpty(str2) ^ 1, "id token string cannot be null or empty");
        this.zzr = str;
        this.zzak = str2;
    }
