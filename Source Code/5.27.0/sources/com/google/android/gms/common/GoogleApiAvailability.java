...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        if (i == 18) {
            ...
            NotificationCompat.Builder style = new NotificationCompat.Builder(context).setLocalOnly(true).setAutoCancel(true).setContentTitle(str).setStyle(new BigTextStyle().bigText(errorNotificationMessage));
