...
public final class zzc extends Fragment implements LifecycleFragment {
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            Object obj = (zzc) fragmentActivity.getSupportFragmentManager().findFragmentByTag(str);
            if (obj == null || obj.isRemoving()) {
                obj = new zzc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) obj, str).commitAllowingStateLoss();
            }
            zzbe.put(fragmentActivity, new WeakReference(obj));
            return obj;
