            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    ...
                    if (!(this.zzci == null || this.zzbz == null)) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder((String.valueOf(zzt).length() + 70) + String.valueOf(packageName).length());
                    ...
                    if (!this.zzcb.zza(new zza(this.zzbz.zzt(), this.zzbz.getPackageName(), this.zzbz.zzq()), this.zzci, zzj())) {
                        zzt = this.zzbz.zzt();
                        packageName = this.zzbz.getPackageName();
                        StringBuilder stringBuilder2 = new StringBuilder((String.valueOf(zzt).length() + 34) + String.valueOf(packageName).length());
