...
public final class zzoy {
    ...
    public final zzox zzms() {
        return new zzox(this.zzatu, this.zzatv, this.zzatw, this.zzatx, this.zzava, this.zzavb, this.zzavc, this.zzavd, this.zzave, this.zzavf, null);
    }

    /* synthetic */ zzoy(zzos zzos) {
        this();
    }
}
