...
final class zzue extends zzub {
    ...
    L_0x0020:
        r13 = r11 + r9;
        r3 = com.google.android.gms.internal.gtm.zztx.zza(r0, r11);
    ...
    L_0x0034:
        r11 = r7 + r9;
        r1 = com.google.android.gms.internal.gtm.zztx.zza(r0, r7);
    ...
    L_0x0056:
        r13 = r11 + r9;
        r1 = com.google.android.gms.internal.gtm.zztx.zza(r0, r11);
    ...
    L_0x006d:
        r2 = r2 + -2;
        r13 = r11 + r9;
        r11 = com.google.android.gms.internal.gtm.zztx.zza(r0, r11);
    ...
    L_0x0083:
        r11 = r13 + r9;
        r1 = com.google.android.gms.internal.gtm.zztx.zza(r0, r13);
        ...
        if (((i | i2) | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i4) {
                ...
                if (zzua.zzd(zza2)) {
                    ...
                    while (i5 < i4) {
                        zza2 = zztx.zza(bArr, (long) i5);
                        if (!zzua.zzd(zza2)) {
                            break;
                        }
                        i5++;
                        i3 = i7 + 1;
                        zzua.zza(zza2, cArr, i7);
                        i7 = i3;
                    }
                    i = i5;
                    i6 = i7;
                    ...
                    if (i5 < i4) {
                        i7 = i5 + 1;
                        i3 = i6 + 1;
                        zzua.zza(zza2, zztx.zza(bArr, (long) i5), cArr, i6);
                        i = i7;
                        i6 = i3;
                    } else {
                        throw zzrk.zzpw();
                    ...
                    if (i5 < i4 - 1) {
                        ...
                        i3 = i7 + 1;
                        int i8 = i6 + 1;
                        zzua.zza(zza2, zztx.zza(bArr, (long) i5), zztx.zza(bArr, (long) i7), cArr, i6);
                        i = i3;
                        i6 = i8;
                    } else {
                        throw zzrk.zzpw();
                    ...
                    i7 = i5 + 1;
                    byte zza3 = zztx.zza(bArr, (long) i5);
                    i5 = i7 + 1;
                    int i9 = i5 + 1;
                    int i10 = i6 + 1;
                    zzua.zza(zza2, zza3, zztx.zza(bArr, (long) i7), zztx.zza(bArr, (long) i5), cArr, i6);
                    i = i9;
                    i6 = i10 + 1;
                } else {
                    throw zzrk.zzpw();
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < c && j < j2) {
                ...
                j6 = j + j3;
                zztx.zza(bArr2, j, (byte) ((charAt2 >>> 6) | 960));
                j7 = j6 + j3;
                zztx.zza(bArr2, j6, (byte) ((charAt2 & 63) | 128));
                j4 = j7;
                j = j3;
                i3++;
                c = 128;
                ...
                j6 = j + j3;
                zztx.zza(bArr2, j, (byte) ((charAt2 >>> 12) | 480));
                j7 = j6 + j3;
                zztx.zza(bArr2, j6, (byte) (((charAt2 >>> 6) & 63) | 128));
                long j8 = j7 + 1;
                zztx.zza(bArr2, j7, (byte) ((charAt2 & 63) | 128));
                j4 = j8;
                j = 1;
            } else if (j <= j2 - 4) {
                i4 = i3 + 1;
                if (i4 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        long j9 = j + 1;
                        zztx.zza(bArr2, j, (byte) ((i3 >>> 18) | 240));
                        j = j9 + 1;
                        zztx.zza(bArr2, j9, (byte) (((i3 >>> 12) & 63) | 128));
                        j6 = j + 1;
                        zztx.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                        j = 1;
                        j4 = j6 + 1;
                        zztx.zza(bArr2, j6, (byte) ((i3 & 63) | 128));
                        i3 = i4;
                        i3++;
                        c = 128;
                        j5 = j;
            ...
            while (i2 < length) {
                ...
                if (charAt < c && position < limit) {
                    ...
                    if ((charAt < 55296 || 57343 < charAt) && position <= limit - 3) {
                        j3 = position + 1;
                        zztx.zza(position, (byte) ((charAt >>> 12) | 480));
                        j4 = j3 + 1;
                        zztx.zza(j3, (byte) (((charAt >>> 6) & 63) | 128));
                        j3 = j4 + 1;
                        zztx.zza(j4, (byte) ((charAt & 63) | 128));
                        position = j3;
                        ...
                        if (i != length) {
                            ...
                            if (Character.isSurrogatePair(charAt, charAt2)) {
                                ...
                                long j6 = position + 1;
                                zztx.zza(position, (byte) ((toCodePoint >>> 18) | 240));
                                j4 = j6 + 1;
                                zztx.zza(j6, (byte) (((toCodePoint >>> 12) & 63) | 128));
                                j6 = j4 + 1;
                                zztx.zza(j4, (byte) (((toCodePoint >>> 6) & 63) | 128));
                                j4 = j6 + 1;
                                zztx.zza(j6, (byte) ((toCodePoint & 63) | 128));
                                i2 = i;
                                position = j4;
                            }
                        } else {
                    ...
                    j2 = zzb;
                    j3 = position + 1;
                    zztx.zza(position, (byte) ((charAt >>> 6) | 960));
                    j4 = j3 + 1;
                    zztx.zza(j3, (byte) ((charAt & 63) | 128));
                    position = j4;
                }
                i2++;
