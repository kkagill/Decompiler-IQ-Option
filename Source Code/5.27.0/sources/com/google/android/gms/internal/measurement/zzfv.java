...
final class zzfv implements zzha {
    ...
    public final <T> zzgx<T> zze(Class<T> cls) {
        ...
        if (zzb.zzvs()) {
            ...
            if (zza(zzb)) {
                return zzgm.zza((Class) cls, zzb, zzgs.zzvw(), zzfs.zzvi(), zzgz.zzwe(), zzep.zztu(), zzgd.zzvp());
            }
            return zzgm.zza((Class) cls, zzb, zzgs.zzvw(), zzfs.zzvi(), zzgz.zzwe(), null, zzgd.zzvp());
        } else if (zza(zzb)) {
            return zzgm.zza((Class) cls, zzb, zzgs.zzvv(), zzfs.zzvh(), zzgz.zzwc(), zzep.zztv(), zzgd.zzvo());
        } else {
            return zzgm.zza((Class) cls, zzb, zzgs.zzvv(), zzfs.zzvh(), zzgz.zzwd(), null, zzgd.zzvo());
        }
    }
