...
public final class CircleOptions extends AbstractSafeParcelable {
    ...
    @Constructor
    CircleOptions(@Param(id = 2) LatLng latLng, @Param(id = 3) double d, @Param(id = 4) float f, @Param(id = 5) int i, @Param(id = 6) int i2, @Param(id = 7) float f2, @Param(id = 8) boolean z, @Param(id = 9) boolean z2, @Param(id = 10) @Nullable List<PatternItem> list) {
        this.zzco = latLng;
        this.zzcp = d;
        this.zzcq = f;
        this.strokeColor = i;
