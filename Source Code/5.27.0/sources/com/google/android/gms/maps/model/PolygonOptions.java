...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    @Constructor
    PolygonOptions(@Param(id = 2) List<LatLng> list, @Param(id = 3) List list2, @Param(id = 4) float f, @Param(id = 5) int i, @Param(id = 6) int i2, @Param(id = 7) float f2, @Param(id = 8) boolean z, @Param(id = 9) boolean z2, @Param(id = 10) boolean z3, @Param(id = 11) int i3, @Param(id = 12) @Nullable List<PatternItem> list3) {
        this.zzcq = 10.0f;
        this.strokeColor = ViewCompat.MEASURED_STATE_MASK;
        this.fillColor = 0;
        this.zzcr = 0.0f;
