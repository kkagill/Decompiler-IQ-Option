...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    @Constructor
    PolylineOptions(@Param(id = 2) List list, @Param(id = 3) float f, @Param(id = 4) int i, @Param(id = 5) float f2, @Param(id = 6) boolean z, @Param(id = 7) boolean z2, @Param(id = 8) boolean z3, @Param(id = 9) @Nullable Cap cap, @Param(id = 10) @Nullable Cap cap2, @Param(id = 11) int i2, @Param(id = 12) @Nullable List<PatternItem> list2) {
        this.width = 10.0f;
        this.color = ViewCompat.MEASURED_STATE_MASK;
        this.zzcr = 0.0f;
        this.zzcs = true;
