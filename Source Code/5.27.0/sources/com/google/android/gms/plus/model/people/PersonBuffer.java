...
public final class PersonBuffer extends AbstractDataBuffer<Person> {
    ...
    public final Person get(int i) {
        DataBufferSafeParcelable dataBufferSafeParcelable = this.zzcm;
        return dataBufferSafeParcelable != null ? (Person) dataBufferSafeParcelable.get(i) : new zzac(this.mDataHolder, i);
    }
}
