...
public final class a {
    ...
    private static boolean a(PackageInfo packageInfo) {
        try {
            ...
            while (true) {
                ...
                if (i >= bArr.length) {
                    break;
                } else if (Arrays.equals(bArr[i], toByteArray)) {
                    return true;
                } else {
                    i++;
                }
    ...
    public static YouTubeInitializationResult ap(Context context) {
        try {
            PackageManager packageManager = context.getPackageManager();
            String aq = aa.aq(context);
            return !a(packageManager.getPackageInfo(aq, 64)) ? YouTubeInitializationResult.SERVICE_INVALID : aa.w(context, aq) ? YouTubeInitializationResult.SERVICE_VERSION_UPDATE_REQUIRED : !packageManager.getApplicationInfo(aq, 0).enabled ? YouTubeInitializationResult.SERVICE_DISABLED : YouTubeInitializationResult.SUCCESS;
