...
public final class y {
    public static Map<String, String> a(Locale locale) {
        ...
        str = "Enable YouTube App";
        hashMap.put("enable_youtube_app_title", str);
        hashMap.put("enable_youtube_app_text", "This app won't work unless you enable the YouTube App.");
        hashMap.put("enable_youtube_app_action", str);
        str = "Update YouTube App";
        hashMap.put("update_youtube_app_title", str);
        hashMap.put("update_youtube_app_text", "This app won't work unless you update the YouTube App.");
        hashMap.put("update_youtube_app_action", str);
        a(hashMap, locale.getLanguage());
        str = String.valueOf(locale.getLanguage());
        String valueOf = String.valueOf(locale.getCountry());
        StringBuilder stringBuilder = new StringBuilder((String.valueOf(str).length() + 1) + String.valueOf(valueOf).length());
        stringBuilder.append(str);
        stringBuilder.append("_");
        stringBuilder.append(valueOf);
        a(hashMap, stringBuilder.toString());
        return hashMap;
    }
    ...
    private static void a(Map<String, String> map, String str) {
        ...
        if ("af".equals(str)) {
            ...
            String str12 = "Actualizar YouTube";
            if ("es_US".equals(str)) {
