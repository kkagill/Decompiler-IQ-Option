...
public final class i {
    private static final int[] ahk = new int[]{5, 7, 10, 11, 12, 14, 18, 20, 24, 28, 36, 42, 48, 56, 62, 68};
    private static final int[][] ahl;
    private static final int[] ahm = new int[256];
    private static final int[] ahn = new int[255];
    ...
    public static String a(String str, k kVar) {
        if (str.length() == kVar.zg()) {
            StringBuilder stringBuilder = new StringBuilder(kVar.zg() + kVar.zh());
            stringBuilder.append(str);
            int yN = kVar.yN();
            if (yN == 1) {
                stringBuilder.append(c(str, kVar.zh()));
            } else {
                stringBuilder.setLength(stringBuilder.capacity());
                int[] iArr = new int[yN];
                int[] iArr2 = new int[yN];
                int i = 0;
                while (i < yN) {
                    int i2 = i + 1;
                    iArr[i] = kVar.cU(i2);
                ...
                for (i = 0; i < yN; i++) {
                    int i3;
                    StringBuilder stringBuilder2 = new StringBuilder(iArr[i]);
                    for (i3 = i; i3 < kVar.zg(); i3 += yN) {
                        stringBuilder2.append(str.charAt(i3));
                    }
                    String c = c(stringBuilder2.toString(), iArr2[i]);
                    i3 = i;
                    int i4 = 0;
                    while (i3 < iArr2[i] * yN) {
                        int i5 = i4 + 1;
                        stringBuilder.setCharAt(kVar.zg() + i3, c.charAt(i4));
                        i3 += yN;
                        i4 = i5;
                    }
                }
