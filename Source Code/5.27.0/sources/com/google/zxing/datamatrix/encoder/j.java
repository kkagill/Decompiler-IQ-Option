...
public final class j {
    ...
    public static String a(String str, SymbolShapeHint symbolShapeHint, a aVar, a aVar2) {
        ...
        hVar.yY();
        int zg = hVar.yX().zg();
        if (!(yR >= zg || i == 0 || i == 5 || i == 4)) {
            hVar.m(254);
        }
        StringBuilder yQ = hVar.yQ();
        if (yQ.length() < zg) {
            yQ.append(129);
        }
        while (yQ.length() < zg) {
            yQ.append(b(129, yQ.length() + 1));
        }
        return hVar.yQ().toString();
    }
    ...
    static int c(CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 == charSequence.length()) {
                ...
                if (j == 1 && bArr[5] > (byte) 0) {
                    return 5;
                }
                if (j == 1 && bArr[4] > (byte) 0) {
                    return 4;
                }
                if (j != 1 || bArr[2] <= (byte) 0) {
                    return (j != 1 || bArr[3] <= (byte) 0) ? 1 : 3;
                } else {
                    return 2;
                }
            }
            ...
            if (i4 >= 4) {
                ...
                if (iArr2[5] >= iArr2[0] && ((bArr2[1] + bArr2[2]) + bArr2[3]) + bArr2[4] != 0) {
                    if (j2 == 1 && bArr2[4] > (byte) 0) {
                        return 4;
                    }
                    if (j2 == 1 && bArr2[2] > (byte) 0) {
                        return 2;
                    }
                    if (j2 == 1 && bArr2[3] > (byte) 0) {
                        return 3;
                    }
