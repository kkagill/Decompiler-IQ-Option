...
public final class a {
    private static final int[] aim = new int[]{31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};
    private static final a[] ain = zs();
    ...
    public int zr() {
        return (this.aio * 4) + 17;
    }

    public b a(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.aiq[errorCorrectionLevel.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.aio);
    }
