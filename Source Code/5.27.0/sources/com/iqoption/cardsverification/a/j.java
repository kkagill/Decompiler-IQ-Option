...
/* compiled from: PerformVerifyFooterBindingImpl */
public class j extends i {
    ...
    static {
        aos.put(d.performVerifyContainer, 1);
        aos.put(d.performVerifyError, 2);
        aos.put(d.performVerifyProgress, 3);
    }
    ...
    private j(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[1], (TextView) objArr[2], (ContentLoadingProgressBar) objArr[3]);
        this.aot = -1;
