...
final class ToolsViewModel$createIndicatorsStream$combiner$2 extends Lambda implements b<Object[], List<? extends h>> {
    final /* synthetic */ c $item;

    ToolsViewModel$createIndicatorsStream$combiner$2(c cVar) {
        this.$item = cVar;
        super(1);
    }
    ...
    public final List<h> invoke(Object[] objArr) {
        ...
        if (obj != null) {
            ...
            if (obj != null) {
                ...
                if (obj2 != null) {
                    return h.aMs.a(u.Z(list), (e) ((Optional) obj2).pN(), this.$item, list, list2);
                }
