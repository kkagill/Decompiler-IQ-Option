...
/* compiled from: ChatFragmentFilePickerBindingImpl */
public class ad extends ac {
    ...
    private ad(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[3], (RecyclerView) objArr[1], (ConstraintLayout) objArr[0], (TextView) objArr[4], (LinearLayout) objArr[2]);
        this.aot = -1;
