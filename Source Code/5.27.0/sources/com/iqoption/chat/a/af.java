...
/* compiled from: ChatFragmentImagePreviewBindingImpl */
public class af extends ae {
    ...
    static {
        aos.put(g.toolbarGuideline, 1);
        aos.put(g.btnBack, 2);
        aos.put(g.btnDownload, 3);
        aos.put(g.title, 4);
        aos.put(g.subtitle, 5);
        aos.put(g.preview, 6);
    }
    ...
    private af(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (ImageView) objArr[3], (ImageView) objArr[6], (TextView) objArr[5], (TextView) objArr[4], (Guideline) objArr[1]);
        this.aot = -1;
