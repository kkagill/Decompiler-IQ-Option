...
/* compiled from: ChatMicroItemBindingImpl */
public class bb extends ba {
    ...
    static {
        aos.put(g.image, 1);
        aos.put(g.lastMessageDate, 2);
        aos.put(g.lastMessageStateIndicator, 3);
        aos.put(g.title, 4);
    ...
    private bb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (TextView) objArr[5], (TextView) objArr[2], (ImageView) objArr[3], (TextView) objArr[4]);
        this.aot = -1;
