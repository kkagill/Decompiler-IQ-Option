...
/* compiled from: ChatRoomSupportToolbarBindingImpl */
public class bo extends bn {
    ...
    private bo(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, null, (TextView) objArr[2], (TextView) objArr[1], (TextView) objArr[3]);
        this.aot = -1;
