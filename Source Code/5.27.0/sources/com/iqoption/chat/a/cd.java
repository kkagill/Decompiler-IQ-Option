...
/* compiled from: ChatUserFileMessageItemBindingImpl */
public class cd extends cc {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            TextViewBindingAdapter.setDrawableStart(this.amZ, ViewDataBinding.getDrawableFromResource(this.amZ, e.chat_user_file_message_icon));
