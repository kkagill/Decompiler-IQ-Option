...
/* compiled from: FragmentChatBindingImpl */
public class cj extends ci {
    ...
    static {
        aos.put(g.chatContentLayer, 1);
        aos.put(g.chatDialogLayer, 2);
    }
    ...
    private cj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[0], (FrameLayout) objArr[1], (FrameLayout) objArr[2]);
        this.aot = -1;
