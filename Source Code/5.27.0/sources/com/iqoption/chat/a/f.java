...
/* compiled from: ChatDialogCantSendReasonBindingImpl */
public class f extends e {
    ...
    private f(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (MaxSizeCardViewLayout) objArr[1], (FrameLayout) objArr[0], (TextView) objArr[2]);
        this.aot = -1;
