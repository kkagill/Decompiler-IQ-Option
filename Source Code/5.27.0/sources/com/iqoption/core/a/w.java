...
public class w extends v {
    ...
    static {
        aor.setIncludes(0, new String[]{"layout_toolbar_black"}, new int[]{1}, new int[]{h.layout_toolbar_black});
        aos.put(g.termsView, 2);
    }
    ...
    private w(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (LinearLayout) objArr[0], (WebView) objArr[2], (r) objArr[1]);
        this.aot = -1;
    ...
    public void invalidateAll() {
        ...
        this.bgp.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code skipped:
            if (r6.bgp.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.core.a.w.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.bgp.setLifecycleOwner(lifecycleOwner);
    }

    /* Access modifiers changed, original: protected */
    public boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((r) obj, i2);
    }
    ...
    public void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.bgp);
    }
}
