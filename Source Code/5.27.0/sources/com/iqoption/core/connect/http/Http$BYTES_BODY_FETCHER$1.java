...
final class Http$BYTES_BODY_FETCHER$1 extends Lambda implements b<ResponseBody, byte[]> {
    public static final Http$BYTES_BODY_FETCHER$1 baG = new Http$BYTES_BODY_FETCHER$1();

    Http$BYTES_BODY_FETCHER$1() {
        super(1);
    }
