...
final class TradingEngineRepository$underlyingStreams$1 extends Lambda implements b<InstrumentType, a<z<Map<Integer, ? extends com.iqoption.core.microservices.tradingengine.response.active.a>>, Map<Integer, ? extends com.iqoption.core.microservices.tradingengine.response.active.a>>> {
    public static final TradingEngineRepository$underlyingStreams$1 beW = new TradingEngineRepository$underlyingStreams$1();

    TradingEngineRepository$underlyingStreams$1() {
        super(1);
    }
    ...
    public final a<z<Map<Integer, com.iqoption.core.microservices.tradingengine.response.active.a>>, Map<Integer, com.iqoption.core.microservices.tradingengine.response.active.a>> invoke(InstrumentType instrumentType) {
        ...
        b tradingEngineRepository$underlyingStreams$1$streamFactory$1 = new TradingEngineRepository$underlyingStreams$1$streamFactory$1(instrumentType);
        ac acVar = ac.bkp;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Underlying: ");
        stringBuilder.append(instrumentType);
        return ac.a(acVar, stringBuilder.toString(), tradingEngineRepository$underlyingStreams$1$streamFactory$1, com.iqoption.core.manager.i.bjd.Ys(), com.iqoption.core.manager.i.bjd.Yh(), 0, null, 48, null);
    }
}
