...
public final class a extends Matrix {
    ...
    public void set(Matrix matrix) {
        kotlin.jvm.internal.i.f(matrix, "src");
        oops();
    }
    ...
    public boolean setConcat(Matrix matrix, Matrix matrix2) {
        kotlin.jvm.internal.i.f(matrix, "a");
        kotlin.jvm.internal.i.f(matrix2, "b");
        oops();
        return false;
    }
    ...
    public boolean preConcat(Matrix matrix) {
        kotlin.jvm.internal.i.f(matrix, "other");
        oops();
        return false;
    }
    ...
    public boolean setRectToRect(RectF rectF, RectF rectF2, ScaleToFit scaleToFit) {
        kotlin.jvm.internal.i.f(rectF, "src");
        kotlin.jvm.internal.i.f(rectF2, "dst");
        kotlin.jvm.internal.i.f(scaleToFit, "stf");
        oops();
        return false;
    }

    public boolean setPolyToPoly(float[] fArr, int i, float[] fArr2, int i2, int i3) {
        kotlin.jvm.internal.i.f(fArr, "src");
        kotlin.jvm.internal.i.f(fArr2, "dst");
        oops();
        return false;
    }

    public void setValues(float[] fArr) {
        kotlin.jvm.internal.i.f(fArr, "values");
        oops();
    }
}
