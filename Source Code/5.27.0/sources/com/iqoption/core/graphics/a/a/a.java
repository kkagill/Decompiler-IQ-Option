...
public abstract class a implements com.iqoption.core.graphics.a.a.c.a {
    private Animator ajN;
    private final ObjectAnimator[] biB;

    public abstract void a(ObjectAnimator objectAnimator, int i, int i2);

    public abstract ObjectAnimator al(int i, int i2);
    ...
    public void ak(int i, int i2) {
        ...
        ObjectAnimator objectAnimator = this.biB[i2];
        if (objectAnimator == null) {
            objectAnimator = al(i, i2);
        }
