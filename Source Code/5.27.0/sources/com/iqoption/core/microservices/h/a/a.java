...
public final class a {
    ...
    @i(bne = {1, 1, 15}, bnf = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u000e\u0010\u0007\u001a\u00020\bXT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\bXT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\bXT¢\u0006\u0002\n\u0000¨\u0006\u000b"}, bng = {"Lcom/iqoption/core/microservices/useronline/response/UserAvailability$Companion;", "", "()V", "EMPTY", "Lcom/iqoption/core/microservices/useronline/response/UserAvailability;", "getEMPTY", "()Lcom/iqoption/core/microservices/useronline/response/UserAvailability;", "STATUS_OFFLINE", "", "STATUS_ONLINE", "STATUS_UNKNOWN", "core_release"})
    /* compiled from: UserAvailability.kt */
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof a) {
                a aVar = (a) obj;
                if (!((this.userId == aVar.userId ? 1 : null) != null && kotlin.jvm.internal.i.y(this.status, aVar.status) && kotlin.jvm.internal.i.y(this.platformId, aVar.platformId) && kotlin.jvm.internal.i.y(this.bDi, aVar.bDi) && kotlin.jvm.internal.i.y(this.bDj, aVar.bDj) && kotlin.jvm.internal.i.y(this.bDk, aVar.bDk))) {
                    return false;
                }
            }
            return false;
    ...
    public a(long j, String str, Integer num, Long l, Long l2, Integer num2) {
        kotlin.jvm.internal.i.f(str, NotificationCompat.CATEGORY_STATUS);
        this.userId = j;
        this.status = str;
        this.platformId = num;
        this.bDi = l;
    ...
    public /* synthetic */ a(long j, String str, Integer num, Long l, Long l2, Integer num2, int i, f fVar) {
        long j2 = (i & 1) != 0 ? -1 : j;
        this(j2, (i & 2) != 0 ? "unknown" : str, (i & 4) != 0 ? (Integer) null : num, (i & 8) != 0 ? (Long) null : l, (i & 16) != 0 ? (Long) null : l2, (i & 32) != 0 ? (Integer) null : num2);
    }
