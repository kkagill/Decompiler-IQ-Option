...
public final class a implements com.iqoption.core.microservices.livedeals.response.a {
    ...
    public static /* synthetic */ a a(a aVar, int i, ActiveType activeType, Integer num, DirectionType directionType, double d, long j, long j2, long j3, String str, int i2, String str2, String str3, Boolean bool, int i3, Object obj) {
        a aVar2 = aVar;
        int i4 = i3;
        return aVar.a((i4 & 1) != 0 ? aVar.getActiveId() : i, (i4 & 2) != 0 ? aVar2.bwz : activeType, (i4 & 4) != 0 ? aVar.agc() : num, (i4 & 8) != 0 ? aVar2.bwB : directionType, (i4 & 16) != 0 ? aVar.ZC() : d, (i4 & 32) != 0 ? aVar.ZU() : j, (i4 & 64) != 0 ? aVar2.expiration : j2, (i4 & 128) != 0 ? aVar.getUserId() : j3, (i4 & 256) != 0 ? aVar.getName() : str, (i4 & 512) != 0 ? aVar.afY() : i2, (i4 & 1024) != 0 ? aVar.afZ() : str2, (i4 & 2048) != 0 ? aVar.aga() : str3, (i4 & 4096) != 0 ? aVar.agb() : bool);
    }
    ...
    public final a a(int i, ActiveType activeType, Integer num, DirectionType directionType, double d, long j, long j2, long j3, String str, int i2, String str2, String str3, Boolean bool) {
        ...
        String str6 = str3;
        Boolean bool2 = bool;
        kotlin.jvm.internal.i.f(activeType, "optionType");
        kotlin.jvm.internal.i.f(directionType, "direction");
        kotlin.jvm.internal.i.f(str2, "flag");
        return new a(i, activeType2, num2, directionType2, d2, j4, j5, j6, str4, i4, str5, str6, bool2);
    }
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof a) {
                a aVar = (a) obj;
                if ((getActiveId() == aVar.getActiveId() ? 1 : null) != null && kotlin.jvm.internal.i.y(this.bwz, aVar.bwz) && kotlin.jvm.internal.i.y(agc(), aVar.agc()) && kotlin.jvm.internal.i.y(this.bwB, aVar.bwB) && Double.compare(ZC(), aVar.ZC()) == 0) {
    ...
    public int hashCode() {
        ...
        ActiveType activeType = this.bwz;
        int i = 0;
    ...
    public InstrumentType getInstrumentType() {
        InstrumentType toInstrumentType = this.bwz.toInstrumentType();
