...
public final class a implements com.iqoption.core.microservices.livedeals.response.a {
    ...
    public static /* synthetic */ a a(a aVar, int i, Integer num, DirectionType directionType, double d, long j, long j2, ExpirationType expirationType, long j3, String str, int i2, String str2, String str3, Boolean bool, int i3, Object obj) {
        a aVar2 = aVar;
        int i4 = i3;
        return aVar.b((i4 & 1) != 0 ? aVar.getActiveId() : i, (i4 & 2) != 0 ? aVar.agc() : num, (i4 & 4) != 0 ? aVar2.bwB : directionType, (i4 & 8) != 0 ? aVar.ZC() : d, (i4 & 16) != 0 ? aVar.ZU() : j, (i4 & 32) != 0 ? aVar2.expiration : j2, (i4 & 64) != 0 ? aVar2.bww : expirationType, (i4 & 128) != 0 ? aVar.getUserId() : j3, (i4 & 256) != 0 ? aVar.getName() : str, (i4 & 512) != 0 ? aVar.afY() : i2, (i4 & 1024) != 0 ? aVar.afZ() : str2, (i4 & 2048) != 0 ? aVar.aga() : str3, (i4 & 4096) != 0 ? aVar.agb() : bool);
    }
    ...
    public final ExpirationType afU() {
        return this.bww;
    }
