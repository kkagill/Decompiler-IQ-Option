...
public final class a {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof a) {
                a aVar = (a) obj;
                if (kotlin.jvm.internal.i.y(this.name, aVar.name)) {
                    if ((this.version == aVar.version ? 1 : null) == null || !kotlin.jvm.internal.i.y(this.bDq, aVar.bDq)) {
                        return false;
                    }
                }
            }
    ...
    public int hashCode() {
        ...
        JsonElement jsonElement = this.bDq;
        if (jsonElement != null) {
    ...
    public final <T> T x(Class<T> cls) {
        ...
        try {
            return d.Um().Ez().fromJson(this.bDq, (Class) cls);
