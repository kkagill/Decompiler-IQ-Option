...
public class MaxSizeLinearLayout extends LinearLayout implements d {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, m.MaxSizeLinearLayout, 0, 0);
        try {
            this.maxHeight = obtainStyledAttributes.getDimensionPixelSize(m.MaxSizeLinearLayout_maxHeight, 0);
            this.maxWidth = obtainStyledAttributes.getDimensionPixelSize(m.MaxSizeLinearLayout_maxWidth, 0);
        } finally {
