...
public final class e implements EGLContextFactory, f {
    ...
    public EGLContext createContext(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
        kotlin.jvm.internal.i.f(egl10, "egl");
        EGLContext eGLContext = bNY;
        if (eGLContext == null) {
    ...
    private final EGLContext a(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
        ...
        bNY = eglCreateContext;
        ChartLibrary.requireInit();
        kotlin.jvm.internal.i.e(eglCreateContext, "egl.eglCreateContext(\n  …y.requireInit()\n        }");
