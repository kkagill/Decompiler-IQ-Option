...
/* compiled from: FragmentPaymentFieldsLightBindingImpl */
public class aa extends z {
    ...
    static {
        aos.put(e.paymentContentContainer, 1);
        aos.put(e.paymentFieldsContainer, 2);
        aos.put(e.paymentFieldsNoInput, 3);
    }
    ...
    private aa(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[1], (LinearLayout) objArr[2], (TextView) objArr[3]);
        this.aot = -1;
