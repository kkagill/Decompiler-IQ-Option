...
public class am extends al {
    ...
    static {
        aos.put(e.methodIcon, 1);
        aos.put(e.methodName, 2);
        aos.put(e.methodDescription, 3);
        aos.put(e.methodChecked, 4);
        aos.put(e.methodLocked, 5);
    }
    ...
    private am(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (View) objArr[4], (LinearLayout) objArr[0], (TextView) objArr[3], (ImageView) objArr[1], (ImageView) objArr[5], (TextView) objArr[2]);
        this.aot = -1;
        this.cCY.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
