...
/* compiled from: ItemPresetLightBindingImpl */
public class aq extends ap {
    ...
    static {
        aos.put(e.presetAmount, 1);
        aos.put(e.presetVipBadge, 2);
    }
    ...
    private aq(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (FrameLayout) objArr[0], (ImageView) objArr[2]);
        this.aot = -1;
