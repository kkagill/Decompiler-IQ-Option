...
/* compiled from: LayoutNavigatorContentBindingLandImpl */
public class bn extends bl {
    ...
    static {
        aos.put(e.depositMethodsPane, 1);
        aos.put(e.depositContentPane, 2);
    }
    ...
    private bn(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[2], (FrameLayout) objArr[1]);
        this.aot = -1;
