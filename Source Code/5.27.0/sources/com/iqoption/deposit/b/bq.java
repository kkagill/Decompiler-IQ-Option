...
/* compiled from: LayoutPerformToolbarTitleLightBindingLandImpl */
public class bq extends bo {
    ...
    static {
        aos.put(e.depositPerformLightTitle, 2);
        aos.put(e.toolbarDepositInfo, 3);
    }
    ...
    private bq(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (LinearLayout) objArr[1], (ImageView) objArr[3], (LinearLayout) objArr[0]);
        this.aot = -1;
        this.cDH.setTag(null);
