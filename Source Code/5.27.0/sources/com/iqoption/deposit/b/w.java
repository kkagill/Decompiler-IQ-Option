...
/* compiled from: FragmentKycWarningBindingImpl */
public class w extends v {
    ...
    static {
        aos.put(e.back, 1);
        aos.put(e.kycWarningDescription, 2);
        aos.put(e.verifyKycButton, 3);
    }
    ...
    private w(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (TextView) objArr[2], (LinearLayout) objArr[0], (TextView) objArr[3]);
        this.aot = -1;
