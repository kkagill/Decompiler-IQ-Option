...
/* compiled from: CustodialScheduleItemBindingLandImpl */
public class g extends e {
    ...
    static {
        aos.put(d.period, 1);
        aos.put(d.chargeDate, 2);
        aos.put(d.feePercent, 3);
        aos.put(d.feeAmount, 4);
    }
    ...
    private g(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (FrameLayout) objArr[0], (TextView) objArr[4], (TextView) objArr[3], (TextView) objArr[1]);
        this.aot = -1;
