        ...
        if (this != obj) {
            if (obj instanceof BalanceChanged) {
                ...
                if ((this.id == balanceChanged.id ? 1 : null) != null) {
                    if ((this.userId == balanceChanged.userId ? 1 : null) == null || !kotlin.jvm.internal.i.y(this.currentBalance, balanceChanged.currentBalance)) {
                        return false;
                    }
                }
            }
