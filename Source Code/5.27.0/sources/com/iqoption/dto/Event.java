...
import com.iqoption.core.analytics.a;
...
public class Event implements a {
    ...
    public String app_version = "5.27.0";
    ...
    public class Builder {
        ...
        public long getDuration() {
            return Event.this.duration.longValue();
        }
    ...
    public Event(Long l, String str, String str2) {
        ...
        this.time = Long.valueOf(com.iqoption.system.d.a.ci(SystemClock.elapsedRealtime()));
    }
    ...
    public static Builder ApiCallBuilder(final String str) {
        AnonymousClass1 anonymousClass1 = new Event(CATEGORY_SYSTEM, API_CALL_EVENT) {
            public String toString() {
