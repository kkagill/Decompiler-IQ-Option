...
public class SpecialOffer implements Parcelable {
    ...
    public boolean equals(Object obj) {
        return obj != null && this.id.longValue() == ((SpecialOffer) obj).id.longValue();
    }

    public boolean isCurrentOffer(long j) {
        return this.startDateTime.longValue() * 1000 <= 3000 + j && j < this.endDateTime.longValue() * 1000 && this.type.equals(TYPE_PICTURE) && !TextUtils.isEmpty(this.pictureUrl);
    }
