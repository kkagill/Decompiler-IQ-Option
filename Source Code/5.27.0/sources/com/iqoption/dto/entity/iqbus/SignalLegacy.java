...
import com.iqoption.fragment.d.b;
...
public class SignalLegacy {
    ...
    public static SignalLegacy fromJson(String str) {
        try {
            return (SignalLegacy) w.aWL().fromJson(str, SignalLegacy.class);
    ...
    public InstrumentType getOptionType() {
        ...
        if (this.option_type_id != null) {
            a a = com.iqoption.app.helpers.a.Gs().a(this.active_id, a.eZ(this.option_type_id.intValue()));
            Object obj3 = this.option_type_id.intValue() == 3 ? 1 : null;
            if (this.option_type_id.intValue() == 1) {
                obj2 = 1;
            }
            if (a != null) {
                return a.eZ(this.option_type_id.intValue());
            }
            obj = obj2;
            obj2 = obj3;
        } else {
        ...
        if (((obj2 == null && InstrumentType.TURBO_INSTRUMENT == instrumentType) || (obj == null && InstrumentType.BINARY_INSTRUMENT == instrumentType)) && com.iqoption.app.helpers.a.Gs().a(this.active_id, instrumentType) != null) {
            return instrumentType;
        }
        if (obj2 == null && com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.TURBO_INSTRUMENT) != null) {
            return InstrumentType.TURBO_INSTRUMENT;
        }
        if (obj == null && com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.BINARY_INSTRUMENT) != null) {
            return InstrumentType.BINARY_INSTRUMENT;
        }
        if (com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.DIGITAL_INSTRUMENT) != null) {
            return InstrumentType.DIGITAL_INSTRUMENT;
        }
        if (com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.CFD_INSTRUMENT) != null) {
            return InstrumentType.CFD_INSTRUMENT;
        }
        if (com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.FOREX_INSTRUMENT) != null) {
            return InstrumentType.FOREX_INSTRUMENT;
        }
        return com.iqoption.app.helpers.a.Gs().a(this.active_id, InstrumentType.CRYPTO_INSTRUMENT) != null ? InstrumentType.CRYPTO_INSTRUMENT : null;
    }

    public boolean isActiveAvailable() {
        a a = com.iqoption.app.helpers.a.Gs().a(this.active_id, getOptionType());
        return a != null && com.iqoption.util.c.a.z(a);
    }

    public boolean isMaxMin() {
        return this.type != null && b.dqn.contains(this.type);
    }

    private boolean isActiveFound() {
        return com.iqoption.app.helpers.a.Gs().a(this.active_id, getOptionType()) != null;
    }
}
