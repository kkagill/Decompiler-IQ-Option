...
/* compiled from: TopPanelBindingImpl */
public class aae extends aad {
    ...
    public aae(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 1, aor, aos));
    }

    private aae(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
