...
public class aak extends aaj {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            a.b(this.cuB, this.cuB.getResources().getDimension(R.dimen.dp6), ViewDataBinding.getColorFromResource(this.cuB, R.color.grey_blur_70));
        }
    }
}
