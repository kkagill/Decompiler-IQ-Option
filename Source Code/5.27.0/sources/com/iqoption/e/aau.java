...
/* compiled from: VipEducationItemViewBindingImpl */
public class aau extends aat {
    ...
    static {
        aos.put(R.id.category_icon, 1);
        aos.put(R.id.title, 2);
        aos.put(R.id.subtitle, 3);
        aos.put(R.id.down_icon, 4);
    }

    public aau(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 5, aor, aos));
    }

    private aau(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
