...
/* compiled from: VipEducationSessionItemBindingImpl */
public class aaw extends aav {
    ...
    public aaw(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 4, aor, aos));
    }

    private aaw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
