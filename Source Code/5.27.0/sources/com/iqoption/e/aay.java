...
public class aay extends aax {
    ...
    public aay(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 3, aor, aos));
    }

    private aay(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
