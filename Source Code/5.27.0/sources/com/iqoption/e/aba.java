...
public class aba extends aaz implements a {
    @Nullable
    ...
    private long aot;
    @Nullable
    private final OnClickListener cuX;
    ...
    static {
        ...
        aos.put(R.id.thumbnail, 4);
        aos.put(R.id.thumbnailFilter, 5);
        aos.put(R.id.durationContainer, 6);
        aos.put(R.id.duration, 7);
        aos.put(R.id.playButton, 8);
    }

    public aba(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.mapBindings(dataBindingComponent, view, 9, aor, aos));
    }

    private aba(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        setRootTag(view);
        this.cuX = new com.iqoption.g.a.a(this, 1);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.cle.setOnClickListener(this.cuX);
        }
    }
