...
/* compiled from: ActivityProDepositBindingImpl */
public class ae extends ad {
    ...
    static {
        aos.put(R.id.proDepositContainer, 1);
        aos.put(R.id.splashContainer, 2);
    }
    ...
    private ae(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[1], (FrameLayout) objArr[0], (FrameLayout) objArr[2]);
        this.aot = -1;
