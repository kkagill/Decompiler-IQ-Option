...
/* compiled from: ActivityWelcomeOnboardingBindingImpl */
public class am extends al {
    ...
    static {
        ...
        aos.put(R.id.introStub, 2);
        aos.put(R.id.ic_cysec, 3);
        aos.put(R.id.splash_connecting_info, 4);
        aos.put(R.id.introLogo, 5);
    }
    ...
    private am(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[1], (ImageView) objArr[3], (LottieAnimationView) objArr[5], (FrameLayout) objArr[2], (TextView) objArr[4]);
        this.aot = -1;
