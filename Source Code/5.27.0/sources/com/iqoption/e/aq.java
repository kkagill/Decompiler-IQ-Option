...
/* compiled from: AssetBaseCfdItemBindingImpl */
public class aq extends ap {
    ...
    static {
        aos.put(R.id.minIvest, 1);
        aos.put(R.id.spread, 2);
        aos.put(R.id.leverage, 3);
        aos.put(R.id.expTime, 4);
        aos.put(R.id.commissions, 5);
    }
