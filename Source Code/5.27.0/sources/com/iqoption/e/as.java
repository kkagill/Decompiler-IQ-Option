...
/* compiled from: AssetBaseOptionsItemBindingImpl */
public class as extends ar {
    ...
    static {
        ...
        aos.put(R.id.profitContainer, 3);
        aos.put(R.id.profit, 4);
    ...
    private as(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[5], (TextView) objArr[1], (TextView) objArr[4], (LinearLayout) objArr[3], (TextView) objArr[2]);
        this.aot = -1;
