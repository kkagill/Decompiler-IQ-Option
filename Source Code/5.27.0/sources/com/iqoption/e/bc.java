...
/* compiled from: AssetInfoPriceItemBindingImpl */
public class bc extends bb {
    ...
    static {
        aos.put(R.id.mktTitle, 1);
        aos.put(R.id.mktValue, 2);
        aos.put(R.id.ratioTitle, 3);
        aos.put(R.id.ratioValue, 4);
        aos.put(R.id.btnExpand, 5);
    }
    ...
    private bc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[5], (TextView) objArr[1], (TextView) objArr[2], (TextView) objArr[3], (TextView) objArr[4]);
        this.aot = -1;
