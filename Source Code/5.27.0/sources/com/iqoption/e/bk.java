...
/* compiled from: AssetInfoTitleItemBindingImpl */
public class bk extends bj {
    ...
    static {
        ...
        aos.put(R.id.changeValue, 3);
        aos.put(R.id.btnFavorites, 4);
        aos.put(R.id.btnAlert, 5);
        aos.put(R.id.alertsBadge, 6);
    }
    ...
    private bk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[6], (ImageView) objArr[5], (ImageView) objArr[4], (TextView) objArr[3], (TextView) objArr[1], (TextView) objArr[2]);
        this.aot = -1;
