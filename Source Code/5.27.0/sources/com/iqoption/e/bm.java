...
/* compiled from: AssetInfoTradersPulseItemBindingImpl */
public class bm extends bl {
    ...
    static {
        ...
        aos.put(R.id.tradersMoodBar, 2);
        aos.put(R.id.sellPercente, 3);
        aos.put(R.id.buyPercente, 4);
    }
    ...
    private bm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[4], (TextView) objArr[3], (TextView) objArr[1], (TradersMoodBar) objArr[2]);
        this.aot = -1;
