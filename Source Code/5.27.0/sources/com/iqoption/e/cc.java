...
/* compiled from: AssetsBoItemBindingImpl */
public class cc extends cb {
    ...
    private cc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (cv) objArr[1], (ImageView) objArr[2], (LinearLayout) objArr[0], (TextView) objArr[3], (TextView) objArr[5], (TextView) objArr[4]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.cc.hasPendingBindings():boolean");
    }
