...
/* compiled from: AssetsCfdItemBindingImpl */
public class cg extends cf {
    ...
    static {
        ...
        aos.put(R.id.diff, 5);
        aos.put(R.id.spread, 6);
        aos.put(R.id.leverage, 7);
    }
    ...
    private cg(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (cv) objArr[1], (TextView) objArr[5], (ImageView) objArr[2], (LinearLayout) objArr[0], (TextView) objArr[7], (TextView) objArr[3], (TextView) objArr[4], (TextView) objArr[6]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.cg.hasPendingBindings():boolean");
    }
