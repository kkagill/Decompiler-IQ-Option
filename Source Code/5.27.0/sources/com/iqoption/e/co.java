...
/* compiled from: AssetsHeaderBoBindingImpl */
public class co extends cn {
    ...
    static {
        aos.put(R.id.sortLabelName, 1);
        aos.put(R.id.sortIndicatorName, 2);
        aos.put(R.id.sortLabelProfit, 3);
        aos.put(R.id.sortIndicatorProfit, 4);
    }
    ...
    private co(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[0], (ImageView) objArr[2], (ImageView) objArr[4], (TextView) objArr[1], (TextView) objArr[3]);
        this.aot = -1;
