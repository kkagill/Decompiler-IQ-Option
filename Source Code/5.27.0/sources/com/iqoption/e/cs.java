...
/* compiled from: AssetsHeaderDoBindingImpl */
public class cs extends cr {
    ...
    static {
        ...
        aos.put(R.id.containerSpotProfit, 7);
        aos.put(R.id.sortLabelSpotProfit, 8);
        aos.put(R.id.sortIndicatorSpotProfit, 9);
    }
    ...
    private cs(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (LinearLayout) objArr[4], (LinearLayout) objArr[1], (LinearLayout) objArr[7], (LinearLayout) objArr[0], (ImageView) objArr[6], (ImageView) objArr[3], (ImageView) objArr[9], (TextView) objArr[5], (TextView) objArr[2], (TextView) objArr[8]);
        this.aot = -1;
