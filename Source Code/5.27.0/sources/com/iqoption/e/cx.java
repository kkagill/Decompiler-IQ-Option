...
/* compiled from: AssetsMultiItemBinding */
public abstract class cx extends ViewDataBinding {
    ...
    protected cx(Object obj, View view, int i, cv cvVar, TextView textView, ImageView imageView, LinearLayout linearLayout, TextView textView2, TextView textView3, TextView textView4) {
        super(obj, view, i);
        this.bXr = cvVar;
