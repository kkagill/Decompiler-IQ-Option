...
/* compiled from: DialogClosedDealsBottomOptionByTickBindingImpl */
public class ev extends eu {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            TextViewBindingAdapter.setDrawableLeft(this.cae, ViewDataBinding.getDrawableFromResource(this.cae, R.drawable.ic_info_filled_white_24dp));
        }
    }
}
