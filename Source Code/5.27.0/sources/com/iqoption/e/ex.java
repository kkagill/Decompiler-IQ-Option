...
/* compiled from: DialogClosedDealsHeaderCfdBindingImpl */
public class ex extends ew {
    ...
    static {
        ...
        aos.put(R.id.investment, 2);
        aos.put(R.id.multiply, 3);
        aos.put(R.id.total, 4);
    }
    ...
    private ex(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RobotoTextView) objArr[1], (RobotoTextView) objArr[2], (RobotoTextView) objArr[3], (RobotoTextView) objArr[4]);
        this.aot = -1;
