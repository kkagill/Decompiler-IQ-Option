...
/* compiled from: DialogWarningBindingImpl */
public class hf extends he {
    ...
    static {
        ...
        aos.put(R.id.closeButton, 2);
        aos.put(R.id.titleWarning, 3);
        aos.put(R.id.descrWarning, 4);
    }
    ...
    private hf(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (RobotoTextView) objArr[4], (TextView) objArr[3], (RelativeLayout) objArr[1]);
        this.aot = -1;
