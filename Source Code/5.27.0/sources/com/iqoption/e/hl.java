...
/* compiled from: DialogWhatsNewVideoDelegateBindingImpl */
public class hl extends hk {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            a.a(this.cdL, this.cdL.getResources().getDimension(R.dimen.dp4), false);
            a.n(this.cdM, ViewDataBinding.getColorFromResource(this.cdM, R.color.black_10));
        }
    }
}
