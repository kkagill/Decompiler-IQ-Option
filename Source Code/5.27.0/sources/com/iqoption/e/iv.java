...
/* compiled from: FragmentInfoAssetBindingImpl */
public class iv extends iu {
    ...
    private iv(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (ConstraintLayout) objArr[0], (ViewPager) objArr[3], (TabLayout) objArr[2]);
        this.aot = -1;
