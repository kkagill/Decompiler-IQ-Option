...
/* compiled from: FragmentKycAcceptableDocumentsBindingImpl */
public class jb extends ja {
    ...
    static {
        ...
        aos.put(R.id.kycAcceptableDocumentsAddress, 3);
    }
    ...
    private jb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (LinearLayout) objArr[3], (pj) objArr[2]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jb.hasPendingBindings():boolean");
    }
