...
/* compiled from: FragmentKycAddressOldBindingImpl */
public class jf extends je {
    ...
    static {
        ...
        aos.put(R.id.addressTitle, 4);
        aos.put(R.id.addressLine1, 5);
        aos.put(R.id.addressLine2, 6);
    }
    ...
    private jf(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (SoftKeyboardEditText) objArr[5], (SoftKeyboardEditText) objArr[6], (TextView) objArr[4], (pj) objArr[2], (pf) objArr[3]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jf.hasPendingBindings():boolean");
    }
