...
/* compiled from: FragmentKycCountryOldBindingImpl */
public class jj extends ji {
    ...
    static {
        ...
        aos.put(R.id.residentialCountry, 3);
        aos.put(R.id.countryPicker, 4);
        aos.put(R.id.citizenCheckbox, 5);
    }
    ...
    private jj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (AppCompatCheckBox) objArr[5], (PositionPicker) objArr[4], (pj) objArr[1], (pf) objArr[2], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jj.hasPendingBindings():boolean");
    }
