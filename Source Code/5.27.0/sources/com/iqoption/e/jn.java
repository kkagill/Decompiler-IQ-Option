...
/* compiled from: FragmentKycDateOfBirthOldBindingImpl */
public class jn extends jm {
    ...
    private jn(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (SoftKeyboardEditText) objArr[4], (TextView) objArr[3], (pj) objArr[2], (ConfirmButtonView) objArr[1], (NumPad) objArr[5]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jn.hasPendingBindings():boolean");
    }
