...
/* compiled from: FragmentKycDocumentAddressBindingImpl */
public class jp extends jo {
    ...
    static {
        ...
        aos.put(R.id.addressOfResidenceText, 2);
        aos.put(R.id.question, 3);
        aos.put(R.id.documentTypesProgress, 4);
        aos.put(R.id.answers, 5);
        aos.put(R.id.nextButton, 6);
    }
    ...
    private jp(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[2], (LinearLayout) objArr[5], (ContentLoadingProgressBar) objArr[4], (pj) objArr[1], (ConfirmButtonView) objArr[6], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jp.hasPendingBindings():boolean");
    }
