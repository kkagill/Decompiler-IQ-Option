...
public class jx extends jw {
    ...
    private jx(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (SoftKeyboardEditText) objArr[4], (FormattedTextView) objArr[3], (pj) objArr[2], (ConfirmButtonView) objArr[1]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jx.hasPendingBindings():boolean");
    }
