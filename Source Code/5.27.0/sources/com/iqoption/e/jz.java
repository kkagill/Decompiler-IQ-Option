...
/* compiled from: FragmentKycEmailConfirmedBindingImpl */
public class jz extends jy {
    ...
    private jz(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (RobotoTextView) objArr[4], (pj) objArr[2], (pf) objArr[3]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.jz.hasPendingBindings():boolean");
    }
