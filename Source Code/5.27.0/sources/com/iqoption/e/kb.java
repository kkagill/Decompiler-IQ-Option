...
/* compiled from: FragmentKycFinishOldBindingImpl */
public class kb extends ka {
    ...
    static {
        aos.put(R.id.finishIcon, 1);
        aos.put(R.id.finishText, 2);
        aos.put(R.id.finishDescription, 3);
        aos.put(R.id.nextButton, 4);
    }
    ...
    private kb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[3], (ImageView) objArr[1], (FormattedTextView) objArr[2], (ConfirmButtonView) objArr[4]);
        this.aot = -1;
