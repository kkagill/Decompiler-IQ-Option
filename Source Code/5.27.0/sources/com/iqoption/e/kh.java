...
/* compiled from: FragmentKycPhoneBindingImpl */
public class kh extends kg {
    ...
    static {
        ...
        aos.put(R.id.phone, 4);
        aos.put(R.id.numPad, 5);
    }
    ...
    private kh(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (pj) objArr[2], (ConfirmButtonView) objArr[1], (NumPad) objArr[5], (SoftKeyboardEditText) objArr[4], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kh.hasPendingBindings():boolean");
    }
