...
/* compiled from: FragmentKycPhoneConfirmOldBindingImpl */
public class kj extends ki {
    ...
    static {
        ...
        aos.put(R.id.code, 4);
        aos.put(R.id.notReceivedCodeText, 5);
        aos.put(R.id.resendTime, 6);
        aos.put(R.id.resend, 7);
        aos.put(R.id.numPad, 8);
    }
    ...
    private kj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (SoftKeyboardEditText) objArr[4], (FormattedTextView) objArr[3], (pj) objArr[2], (ConfirmButtonView) objArr[1], (TextView) objArr[5], (NumPad) objArr[8], (TextView) objArr[7], (TextView) objArr[6]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kj.hasPendingBindings():boolean");
    }
