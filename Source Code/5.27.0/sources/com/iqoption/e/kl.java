...
/* compiled from: FragmentKycPhoneConfirmedBindingImpl */
public class kl extends kk {
    ...
    private kl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (pj) objArr[2], (pf) objArr[3], (TextView) objArr[4]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kl.hasPendingBindings():boolean");
    }
