...
/* compiled from: FragmentKycQuestionSingleChoiceOldBindingImpl */
public class kp extends ko {
    ...
    static {
        ...
        aos.put(R.id.question, 3);
        aos.put(R.id.answers, 4);
    }
    ...
    private kp(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (LinearLayout) objArr[4], (pj) objArr[1], (pf) objArr[2], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kp.hasPendingBindings():boolean");
    }
