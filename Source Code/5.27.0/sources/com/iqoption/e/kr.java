...
/* compiled from: FragmentKycQuestionTextOldBindingImpl */
public class kr extends kq {
    ...
    private kr(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (EditText) objArr[4], (pj) objArr[1], (pf) objArr[2], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0021:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kr.hasPendingBindings():boolean");
    }
