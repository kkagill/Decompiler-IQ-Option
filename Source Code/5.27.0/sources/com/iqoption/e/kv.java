...
/* compiled from: FragmentKycQuestionYesNoBindingImpl */
public class kv extends ku {
    ...
    private kv(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (pj) objArr[1], (RobotoTextView) objArr[4], (TextView) objArr[2], (RobotoTextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kv.hasPendingBindings():boolean");
    }
