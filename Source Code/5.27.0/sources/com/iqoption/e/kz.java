...
/* compiled from: FragmentKycReportableErrorOldBindingImpl */
public class kz extends ky {
    ...
    static {
        ...
        aos.put(R.id.kycReportableWarning, 2);
        aos.put(R.id.contactSupport, 3);
    }
    ...
    private kz(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (FormattedTextView) objArr[3], (TextView) objArr[2], (pj) objArr[1]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.kz.hasPendingBindings():boolean");
    }
