...
/* compiled from: FragmentKycReportableOldBindingImpl */
public class lb extends la {
    ...
    static {
        ...
        aos.put(R.id.reportableTitle, 2);
        aos.put(R.id.description, 3);
        aos.put(R.id.yes, 4);
        aos.put(R.id.no, 5);
    }
    ...
    private lb(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[3], (pj) objArr[1], (ConfirmButtonView) objArr[5], (TextView) objArr[2], (ConfirmButtonView) objArr[4]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.lb.hasPendingBindings():boolean");
    }
