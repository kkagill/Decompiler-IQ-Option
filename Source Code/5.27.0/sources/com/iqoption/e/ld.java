...
/* compiled from: FragmentKycRisksOldBindingImpl */
public class ld extends lc {
    ...
    static {
        ...
        aos.put(R.id.webView, 2);
        aos.put(R.id.progress, 3);
    }
    ...
    private ld(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (pj) objArr[1], (ContentLoadingProgressBar) objArr[3], (WebView) objArr[2]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.ld.hasPendingBindings():boolean");
    }
