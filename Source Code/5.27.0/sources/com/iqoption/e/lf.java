...
/* compiled from: FragmentKycSexOldBindingImpl */
public class lf extends le {
    ...
    static {
        ...
        aos.put(R.id.emailTitle, 2);
        aos.put(R.id.male, 3);
        aos.put(R.id.female, 4);
    }
    ...
    private lf(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[2], (TextView) objArr[4], (pj) objArr[1], (TextView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.lf.hasPendingBindings():boolean");
    }
