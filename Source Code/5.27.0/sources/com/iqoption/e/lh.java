...
/* compiled from: FragmentKycStartNonRegulatedBindingImpl */
public class lh extends lg {
    ...
    private lh(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[2], (pj) objArr[1], (ConfirmButtonView) objArr[3]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.lh.hasPendingBindings():boolean");
    }
