...
/* compiled from: FragmentRightPanelBindingImpl */
public class nc extends nb {
    ...
    static {
        aos.put(R.id.delegateLayout, 1);
        aos.put(R.id.currentTime, 2);
    }
    ...
    private nc(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (FrameLayout) objArr[1]);
        this.aot = -1;
