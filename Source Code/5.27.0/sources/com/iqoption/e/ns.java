...
/* compiled from: FragmentVideoEducationCategoriesBindingImpl */
public class ns extends nr {
    ...
    static {
        aos.put(R.id.toolbarBottom, 1);
        aos.put(R.id.title, 2);
        aos.put(R.id.categories, 3);
    }
    ...
    private ns(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (RecyclerView) objArr[3], (TextView) objArr[2], (Guideline) objArr[1]);
        this.aot = -1;
