...
public class oi extends oh implements a {
    @Nullable
    ...
    private long aot;
    @Nullable
    private final OnClickListener clh;
    ...
    private oi(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        setRootTag(view);
        this.clh = new com.iqoption.g.a.a(this, 1);
        invalidateAll();
    }
    ...
    public void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.cle.setOnClickListener(this.clh);
        }
    }
