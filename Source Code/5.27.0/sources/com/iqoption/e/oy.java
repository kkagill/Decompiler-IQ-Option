...
/* compiled from: ItemLocaleAssetCountrySuggestBindingImpl */
public class oy extends ox {
    ...
    static {
        aos.put(R.id.flagIcon, 1);
        aos.put(R.id.countryName, 2);
        aos.put(R.id.yourArea, 3);
        aos.put(R.id.countAsset, 4);
    }
    ...
    private oy(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[4], (ConstraintLayout) objArr[0], (TextView) objArr[2], (ImageView) objArr[1], (TextView) objArr[3]);
        this.aot = -1;
