...
/* compiled from: LeftMenuItemCounterBindingImpl */
public class pu extends pt {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            TextViewBindingAdapter.setDrawableLeft(this.cmC, ViewDataBinding.getDrawableFromResource(this.cmC, R.drawable.ic_support));
        }
    }
}
