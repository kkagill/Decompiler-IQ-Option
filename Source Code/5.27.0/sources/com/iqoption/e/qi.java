...
/* compiled from: LeftMenuItemWithProgressBindingImpl */
public class qi extends qh {
    ...
    static {
        aos.put(R.id.itemLabel, 1);
        aos.put(R.id.itemProgress, 2);
    }
    ...
    private qi(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (ContentLoadingProgressBar) objArr[2]);
        this.aot = -1;
