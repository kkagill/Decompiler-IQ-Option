...
/* compiled from: LeftPanelItemBindingImpl */
public class qk extends qj {
    ...
    static {
        ...
        aos.put(R.id.visibleIcon, 3);
        aos.put(R.id.moveIcon, 4);
    }
    ...
    private qk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (ImageView) objArr[4], (FormattedTextView) objArr[2], (ImageView) objArr[3]);
        this.aot = -1;
