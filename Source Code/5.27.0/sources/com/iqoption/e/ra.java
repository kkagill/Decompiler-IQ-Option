...
/* compiled from: MicroPortfolioCfdSingleGroupItemBindingImpl */
public class ra extends qz {
    ...
    static {
        aor.setIncludes(1, new String[]{"micro_portfolio_cfd_info"}, new int[]{2}, new int[]{R.layout.micro_portfolio_cfd_info});
    ...
    private ra(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (qv) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TextView) objArr[7]);
        this.aot = -1;
    ...
    public void invalidateAll() {
        ...
        this.cnI.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code skipped:
            if (r6.cnI.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.ra.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.cnI.setLifecycleOwner(lifecycleOwner);
    }

    /* Access modifiers changed, original: protected */
    public boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((qv) obj, i2);
    }

    private boolean a(qv qvVar, int i) {
        if (i != 0) {
            return false;
        }
        synchronized (this) {
    ...
    public void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.cnI);
    }
}
