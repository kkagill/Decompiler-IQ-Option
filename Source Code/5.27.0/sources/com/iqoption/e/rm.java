...
/* compiled from: MicroPortfolioExpItemBindingImpl */
public class rm extends rl {
    ...
    private rm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ConstraintLayout) objArr[4], (rj) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TimerView) objArr[5], (TextView) objArr[6], (TextView) objArr[7]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.rm.hasPendingBindings():boolean");
    }
