...
/* compiled from: MicroPortfolioExpMultiGroupItemBinding */
public abstract class rn extends ViewDataBinding {
    ...
    @NonNull
    public static rn C(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        return C(layoutInflater, viewGroup, z, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    @Deprecated
    public static rn C(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable Object obj) {
        return (rn) ViewDataBinding.inflateInternal(layoutInflater, R.layout.micro_portfolio_exp_multi_group_item, viewGroup, z, obj);
    }
}
