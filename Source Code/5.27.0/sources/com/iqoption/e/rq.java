...
/* compiled from: MicroPortfolioExpSingleGroupItemBindingImpl */
public class rq extends rp {
    ...
    static {
        aor.setIncludes(1, new String[]{"micro_portfolio_exp_info"}, new int[]{2}, new int[]{R.layout.micro_portfolio_exp_info});
    ...
    private rq(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (TextView) objArr[6], (ConstraintLayout) objArr[4], (rj) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TimerView) objArr[5], (TextView) objArr[7]);
        this.aot = -1;
    ...
    public void invalidateAll() {
        ...
        this.cnW.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code skipped:
            if (r6.cnW.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.rq.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.cnW.setLifecycleOwner(lifecycleOwner);
    }

    /* Access modifiers changed, original: protected */
    public boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((rj) obj, i2);
    }
    ...
    public void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.cnW);
    }
}
