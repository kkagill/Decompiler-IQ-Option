...
/* compiled from: MicroPortfolioMktOnOpenItemBindingImpl */
public class rs extends rr {
    ...
    static {
        ...
        aos.put(R.id.quantity, 5);
        aos.put(R.id.sideIndicator, 6);
        aos.put(R.id.timer_text, 7);
        aos.put(R.id.invest, 8);
    }
    ...
    private rs(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ConstraintLayout) objArr[4], (sj) objArr[2], (RobotoTextView) objArr[8], (TextView) objArr[5], (FrameLayout) objArr[3], (ImageView) objArr[6], (RobotoTextView) objArr[7]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.rs.hasPendingBindings():boolean");
    }
