...
/* compiled from: MicroPortfolioPendingGroupItemBindingImpl */
public class si extends sh {
    ...
    static {
        ...
        aos.put(R.id.expandIndicator, 5);
    ...
    private si(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (TextView) objArr[2], (ImageView) objArr[5], (TextView) objArr[4], (RobotoTextView) objArr[6], (TextView) objArr[3]);
        this.aot = -1;
