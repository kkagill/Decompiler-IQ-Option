...
/* compiled from: MicroPortfolioPendingSingleGroupItemBindingImpl */
public class so extends sn {
    ...
    private so(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (sj) objArr[2], (TextView) objArr[7], (RobotoTextView) objArr[10], (RobotoTextView) objArr[9], (FrameLayout) objArr[3], (ImageView) objArr[8]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.so.hasPendingBindings():boolean");
    }
