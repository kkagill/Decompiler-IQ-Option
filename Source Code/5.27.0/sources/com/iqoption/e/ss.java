...
/* compiled from: MoreTradingOpportunitiesBindingImpl */
public class ss extends sr {
    ...
    static {
        aos.put(R.id.logo_bg, 1);
        aos.put(R.id.whatsNewClose, 2);
        aos.put(R.id.main_title, 3);
        aos.put(R.id.follow_link_button, 4);
    }
    ...
    private ss(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[4], (ImageView) objArr[1], (TextView) objArr[3], (ImageView) objArr[2]);
        this.aot = -1;
