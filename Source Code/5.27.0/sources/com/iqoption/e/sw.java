...
/* compiled from: MultiAssetViewBindingImpl */
public class sw extends sv {
    ...
    static {
        aos.put(R.id.addButton, 1);
        aos.put(R.id.scrollContainer, 2);
    ...
    private sw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (LinearLayout) objArr[3], (HorizontalScrollView) objArr[2]);
        this.aot = -1;
