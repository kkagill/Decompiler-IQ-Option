...
/* compiled from: OtnLeaderBoardFirstItemBindingImpl */
public class tq extends tp {
    ...
    static {
        aos.put(R.id.placeImage, 1);
        aos.put(R.id.countryFlag, 2);
        aos.put(R.id.userName, 3);
        aos.put(R.id.userScore, 4);
    }
    ...
    private tq(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (ImageView) objArr[1], (LinearLayout) objArr[0], (TextView) objArr[3], (TextView) objArr[4]);
        this.aot = -1;
