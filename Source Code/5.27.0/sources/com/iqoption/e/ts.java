...
/* compiled from: OtnLeaderBoardItemBindingImpl */
public class ts extends tr {
    ...
    private ts(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (TextView) objArr[1], (LinearLayout) objArr[0], (TextView) objArr[3], (TextView) objArr[4]);
        this.aot = -1;
