...
/* compiled from: PortfolioCfdSingleGroupItemBindingImpl */
public class uk extends uj {
    ...
    static {
        aor.setIncludes(1, new String[]{"portfolio_cfd_info"}, new int[]{2}, new int[]{R.layout.portfolio_cfd_info});
    ...
    private uk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (ConstraintLayout) objArr[4], (uf) objArr[2], (TextView) objArr[9], (TextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (TextView) objArr[6], (TextView) objArr[7]);
        this.aot = -1;
    ...
    public void invalidateAll() {
        ...
        this.cpY.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code skipped:
            if (r6.cpY.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.uk.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.cpY.setLifecycleOwner(lifecycleOwner);
    }

    /* Access modifiers changed, original: protected */
    public boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : a((uf) obj, i2);
    }

    private boolean a(uf ufVar, int i) {
        if (i != 0) {
            return false;
        }
        synchronized (this) {
    ...
    public void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.cpY);
    }
}
