...
public class vk extends vj {
    ...
    private vk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, (ImageView) objArr[5], (TextView) objArr[6], (ConstraintLayout) objArr[4], (vz) objArr[2], (TextView) objArr[7], (RobotoTextView) objArr[10], (FrameLayout) objArr[3], (ImageView) objArr[8], (RobotoTextView) objArr[9]);
        this.aot = -1;
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.e.vk.hasPendingBindings():boolean");
    }
