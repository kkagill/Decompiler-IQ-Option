...
/* compiled from: PortfolioPendingGroupItemBindingImpl */
public class vw extends vv {
    ...
    private vw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[1], (TextView) objArr[2], (ImageView) objArr[6], (TextView) objArr[4], (RobotoTextView) objArr[7], (TextView) objArr[3], (TextView) objArr[5]);
        this.aot = -1;
