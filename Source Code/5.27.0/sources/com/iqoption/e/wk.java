...
/* compiled from: PriceMovementsHighFrequecyItemBindingImpl */
public class wk extends wj {
    ...
    static {
        aos.put(R.id.signalActive, 1);
        aos.put(R.id.signalValue, 2);
    }
    ...
    private wk(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[1], (RobotoTextView) objArr[2]);
        this.aot = -1;
