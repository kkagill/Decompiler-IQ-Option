...
/* compiled from: PriceMovementsHighFrequencyLayoutBindingImpl */
public class wm extends wl {
    ...
    static {
        aos.put(R.id.noSignalsView, 1);
        aos.put(R.id.rightNowLayout, 2);
    }
    ...
    private wm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FormattedTextView) objArr[1], (RecyclerView) objArr[2]);
        this.aot = -1;
