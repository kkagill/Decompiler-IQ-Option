...
/* compiled from: SessionOtherItemBindingImpl */
public class yw extends yv {
    ...
    static {
        ...
        aos.put(R.id.ip, 4);
        aos.put(R.id.date, 5);
        aos.put(R.id.terminate_button, 6);
    }
    ...
    private yw(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[5], (ImageView) objArr[1], (TextView) objArr[4], (TextView) objArr[2], (ImageView) objArr[6], (TextView) objArr[3]);
        this.aot = -1;
