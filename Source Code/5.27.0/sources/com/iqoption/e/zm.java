...
/* compiled from: TemplateToastBindingImpl */
public class zm extends zl {
    ...
    static {
        ...
        aos.put(R.id.message, 3);
        aos.put(R.id.separator, 4);
        aos.put(R.id.accept, 5);
    }
    ...
    private zm(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[5], (ConstraintLayout) objArr[1], (TextView) objArr[3], (View) objArr[4], (TextView) objArr[2], (FrameLayout) objArr[0]);
        this.aot = -1;
