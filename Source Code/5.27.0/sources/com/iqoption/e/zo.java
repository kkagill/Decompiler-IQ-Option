...
/* compiled from: ToastFxNextExpirationBindingImpl */
public class zo extends zn {
    @Nullable
    ...
    private zo(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[3], (TextView) objArr[4], (ConstraintLayout) objArr[1], (TextView) objArr[5], (FrameLayout) objArr[0], (TextView) objArr[6], (TextView) objArr[2]);
        this.aot = -1;
