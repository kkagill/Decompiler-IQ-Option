...
public class af extends ae {
    ...
    static {
        aos.put(e.view_container, 1);
        aos.put(e.feedProgress, 2);
        aos.put(e.feedOther, 3);
    }
    ...
    private af(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[3], (ContentLoadingProgressBar) objArr[2], (FrameLayout) objArr[1]);
        this.aot = -1;
