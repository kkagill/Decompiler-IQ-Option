...
/* compiled from: FragmentForexCalendarBindingImpl */
public class h extends g {
    ...
    static {
        aor.setIncludes(0, new String[]{"calendar_arrow_button"}, new int[]{1}, new int[]{com.iqoption.core.i.h.calendar_arrow_button});
        aos.put(d.forexList, 2);
    }
    ...
    public void invalidateAll() {
        ...
        this.cTf.invalidateAll();
        requestRebind();
    }

    /* JADX WARNING: Missing block: B:8:0x0013, code skipped:
            if (r6.cTf.hasPendingBindings() == false) goto L_0x0016;
     */
    ...
    L_0x0018:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.forexcalendar.a.h.hasPendingBindings():boolean");
    }

    public void setLifecycleOwner(@Nullable LifecycleOwner lifecycleOwner) {
        super.setLifecycleOwner(lifecycleOwner);
        this.cTf.setLifecycleOwner(lifecycleOwner);
    }

    /* Access modifiers changed, original: protected */
    public boolean onFieldChange(int i, Object obj, int i2) {
        return i != 0 ? false : b((a) obj, i2);
    }

    private boolean b(a aVar, int i) {
        if (i != com.iqoption.forexcalendar.a._all) {
            return false;
        }
        synchronized (this) {
            this.aot |= 1;
    ...
    public void executeBindings() {
        ...
        ViewDataBinding.executeBindingsOn(this.cTf);
    }
}
