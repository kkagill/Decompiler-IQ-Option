...
public final class i extends k {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof i) {
                i iVar = (i) obj;
                if (kotlin.jvm.internal.i.y(this.aoX, iVar.aoX) && Double.compare(adn(), iVar.adn()) == 0) {
                    if ((this.dcb == iVar.dcb ? 1 : null) != null) {
                        if ((aAI() == iVar.aAI() ? 1 : null) != null && kotlin.jvm.internal.i.y(this.image, iVar.image) && kotlin.jvm.internal.i.y(getName(), iVar.getName())) {
                            if (!((QE() == iVar.QE() ? 1 : null) != null && kotlin.jvm.internal.i.y(this.Dy, iVar.Dy) && kotlin.jvm.internal.i.y(this.dcd, iVar.dcd) && kotlin.jvm.internal.i.y(this.dci, iVar.dci))) {
                                return false;
                            }
                        }
                    }
    ...
    public String toString() {
        ...
        stringBuilder.append("AssetDo(asset=");
    ...
    public i(a aVar, double d, boolean z, int i, String str, String str2, boolean z2, String str3, String str4, String str5) {
