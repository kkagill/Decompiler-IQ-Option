...
final class TrendingTodayModel$loadPopularList$bestProfitability$1 extends Lambda implements b<a, Boolean> {
    final /* synthetic */ long $timeSync;

    TrendingTodayModel$loadPopularList$bestProfitability$1(long j) {
        this.$timeSync = j;
        super(1);
    }
    ...
    public final boolean w(a aVar) {
        ...
        return aVar.aX(this.$timeSync) && !aVar.isSuspended();
    }
}
