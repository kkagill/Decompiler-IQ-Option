...
final class TrendingTodayModel$loadPopularList$topLosers$1 extends Lambda implements b<Pair<? extends a, ? extends com.iqoption.core.microservices.f.a.a.a>, d> {
    public static final TrendingTodayModel$loadPopularList$topLosers$1 dqX = new TrendingTodayModel$loadPopularList$topLosers$1();

    TrendingTodayModel$loadPopularList$topLosers$1() {
        super(1);
    }
    ...
    public final d invoke(Pair<? extends a, com.iqoption.core.microservices.f.a.a.a> pair) {
        ...
        return (f == null || Double.compare(f.doubleValue(), 0.001d) != -1) ? null : new d(PopularType.TOP_LOSERS, (a) pair.getFirst(), f, null, 8, null);
    }
}
