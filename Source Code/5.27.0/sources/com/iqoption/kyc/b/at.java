...
/* compiled from: FragmentKycRisksBindingImpl */
public class at extends as {
    ...
    static {
        aos.put(d.kycRisksWebView, 1);
        aos.put(d.kycRisksProgress, 2);
    }
    ...
    private at(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ContentLoadingProgressBar) objArr[2], (WebView) objArr[1]);
        this.aot = -1;
