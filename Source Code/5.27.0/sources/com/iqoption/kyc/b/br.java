...
/* compiled from: LayoutKycBottomBarBindingImpl */
public class br extends bq {
    ...
    private br(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (TextView) objArr[2], (ContentLoadingProgressBar) objArr[3], (TextView) objArr[1]);
        this.aot = -1;
