...
/* compiled from: LayoutKycButtonBindingImpl */
public class bt extends bs {
    ...
    public void executeBindings() {
        ...
        if ((j & 1) != 0) {
            a.a(this.dwD, ViewDataBinding.getColorFromResource(this.dwD, o.a.white));
        }
    }
}
