...
/* compiled from: FragmentKycDateOfBirthBindingImpl */
public class f extends e {
    ...
    static {
        aos.put(d.kycBirthdayInput, 1);
        aos.put(d.kycBirthdayEdit, 2);
    }
    ...
    private f(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (IQTextInputEditText) objArr[2], (TextInputLayout) objArr[1]);
        this.aot = -1;
