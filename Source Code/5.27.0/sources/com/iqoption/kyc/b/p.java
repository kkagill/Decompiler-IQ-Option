...
/* compiled from: FragmentKycGovernanceBindingImpl */
public class p extends o {
    ...
    static {
        aos.put(d.kycAcceptRisks, 1);
        aos.put(d.kycNotAcceptRisks, 2);
    }
    ...
    private p(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (AppCompatRadioButton) objArr[1], (AppCompatRadioButton) objArr[2]);
        this.aot = -1;
