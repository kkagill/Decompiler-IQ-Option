...
@i(bne = {1, 1, 15}, bnf = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, bng = {"<anonymous>", "Lcom/iqoption/microservice/regulators/response/StatusType;", "invoke"})
...
final class ProTraderApplicationStatusDialog$statusType$2 extends Lambda implements a<StatusType> {
    ...
    public final StatusType invoke() {
        Serializable serializable = com.iqoption.core.ext.a.s(this.this$0).getSerializable("ARG_STATUS_TYPE");
