...
public final class SignalTitleViewHolder$$special$$inlined$bindable$1 extends Lambda implements b<j, l> {
    ...
    public final void bU(j jVar) {
        ((k) this.$context).Rw().setText(jVar.getTitle());
    }
}
