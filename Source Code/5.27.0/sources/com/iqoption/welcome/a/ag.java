...
/* compiled from: LayoutWelcomeSocialBindingLandImpl */
public class ag extends ae {
    ...
    static {
        ...
        aos.put(d.facebookLogin, 2);
        aos.put(d.googleLogin, 3);
    }
    ...
    private ag(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (View) objArr[2], (View) objArr[3], (LinearLayout) objArr[0], (TextView) objArr[1]);
        this.aot = -1;
