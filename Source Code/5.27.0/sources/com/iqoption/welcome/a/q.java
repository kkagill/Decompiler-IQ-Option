...
public class q extends p {
    ...
    static {
        aor.setIncludes(2, new String[]{"layout_register_button"}, new int[]{6}, new int[]{e.layout_register_button});
    ...
    private q(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 2, (ImageView) objArr[7], (IQTextInputEditText) objArr[11], (TextInputLayout) objArr[10], (aa) objArr[6], (IQTextInputEditText) objArr[13], (TextInputLayout) objArr[12], (TextView) objArr[1], (FrameLayout) objArr[0], (FrameLayout) objArr[9], (TextView) objArr[8], (ac) objArr[5]);
        this.aot = -1;
    ...
    L_0x002a:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iqoption.welcome.a.q.hasPendingBindings():boolean");
    }
