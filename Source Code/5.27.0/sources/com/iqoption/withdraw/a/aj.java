...
/* compiled from: WithdrawMethodCardLayoutBindingImpl */
public class aj extends ai {
    ...
    static {
        aos.put(d.withdrawMethodContainer, 1);
        aos.put(d.withdrawMethodIcon, 2);
        aos.put(d.withdrawMethodName, 3);
        aos.put(d.withdrawMethodLimit, 4);
    }
    ...
    private aj(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (CardView2) objArr[1], (ImageView) objArr[2], (TextView) objArr[4], (TextView) objArr[3]);
        this.aot = -1;
