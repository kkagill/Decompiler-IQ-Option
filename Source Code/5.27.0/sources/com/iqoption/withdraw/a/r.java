...
/* compiled from: ItemPayoutRegularFieldBindingImpl */
public class r extends q {
    ...
    static {
        aos.put(d.fieldRegular, 1);
        aos.put(d.fieldRegularError, 2);
    }
    ...
    private r(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (PlaceholderedField) objArr[1], (FrameLayout) objArr[0], (TextView) objArr[2]);
        this.aot = -1;
