...
/* compiled from: ToolbarLayoutBindingImpl */
public class x extends w {
    ...
    static {
        ...
        aos.put(d.toolbarTitle, 3);
        aos.put(d.toolbarWithdrawFee, 4);
    }
    ...
    private x(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (TextView) objArr[3], (TextView) objArr[4], (ImageView) objArr[1]);
        this.aot = -1;
