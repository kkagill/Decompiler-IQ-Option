...
public final class BamSDK extends MobileSDK {
    ...
    private BamSDK(Activity activity, String str, String str2, JumioDataCenter jumioDataCenter) {
        ...
        if (activity != null) {
            ...
            y.a();
            Log.d("SDK Build Version: JMSDK 2.14.0 (0-69), TEMPLATE_MATCHER Build Version: 1.124.0");
    ...
    public void addCustomField(String str, String str2, int i, String str3) {
        if (str3 == null || str3.trim().equals("")) {
            this.r.add(new ab(str, str2, i, null));
        } else {
            this.r.add(new ab(str, str2, i, Pattern.compile(str3)));
        }
    }
    ...
    private void a(boolean z) {
        ...
        DataAccess.update(this.b, v.class, this.c);
    }
    ...
    public BamCustomScanPresenter start(BamCustomScanInterface bamCustomScanInterface, BamCustomScanView bamCustomScanView) {
        a(true);
        x xVar = new x();
        return new BamCustomScanPresenter(new g(this.b, xVar, bamCustomScanView, bamCustomScanInterface, this.d), xVar);
    }
}
