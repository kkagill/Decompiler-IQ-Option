...
public class DomainValidator implements Serializable {
    ...
    private static class IDNBUGHOLDER {
        ...
        private static boolean keepsTrailingDot() {
            String str = "a.";
            return str.equals(IDN.toASCII(str));
        }
    }
