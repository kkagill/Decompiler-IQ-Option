...
public class ImageGlower {
    ...
    public ImageGlower(Bitmap bitmap, ImageView imageView, ImageView imageView2, float f) {
        ...
        canvas.drawBitmap(bitmap2, (float) i, (float) i, null);
    ...
    public void setColor(int i) {
        ...
        Bitmap extractAlpha = this.mSource.extractAlpha();
        int i2 = this.mHalfMargin;
        canvas.drawBitmap(extractAlpha, (float) i2, (float) i2, this.mPaint);
