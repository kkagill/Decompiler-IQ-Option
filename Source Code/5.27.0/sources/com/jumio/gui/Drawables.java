...
public class Drawables {
    ...
    public static Drawable generateButtonDrawable(Context context, int i) {
        ...
        RoundRectShape roundRectShape = new RoundRectShape(new float[]{dipToPx2, dipToPx2, dipToPx2, dipToPx2, dipToPx2, dipToPx2, dipToPx2, dipToPx2}, null, null);
        ...
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{r13, shapeDrawable});
        dipToPx3 = (int) dipToPx;
        LayerDrawable layerDrawable2 = layerDrawable;
        layerDrawable2.setLayerInset(0, 0, dipToPx3, 0, 0);
        layerDrawable2.setLayerInset(1, 0, 0, 0, dipToPx3);
