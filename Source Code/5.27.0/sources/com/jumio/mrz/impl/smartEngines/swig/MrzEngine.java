...
public class MrzEngine {
    ...
    public static final class ImageOrientation {
        ...
        public static ImageOrientation swigToEnum(int i) {
            ImageOrientation[] imageOrientationArr = a;
            if (i < imageOrientationArr.length && i >= 0 && imageOrientationArr[i].c == i) {
                return imageOrientationArr[i];
            }
            int i2 = 0;
            while (true) {
                ImageOrientation[] imageOrientationArr2 = a;
                if (i2 >= imageOrientationArr2.length) {
                ...
                } else if (imageOrientationArr2[i2].c == i) {
                    return imageOrientationArr2[i2];
                } else {
                    i2++;
                }
            }
