...
public abstract class NVOverlay implements Overlay {
    ...
    public void calculate(@NonNull DocumentScanMode documentScanMode, @NonNull DocumentFormat documentFormat, Rect rect) {
        ...
        int i = this.w;
        int i2 = this.overlayRightMargin;
        int i3 = this.leftOffset;
        this.overlayRightPixel = i - (i2 + i3);
        i = this.h;
        i2 = this.overlayBottomMargin;
        int i4 = this.topOffset;
        this.overlayBottomPixel = i - (i2 + i4);
        this.overlayLeftPixel = this.overlayLeftMargin + i3;
        this.overlayTopPixel = this.overlayTopMargin + i4;
    }
