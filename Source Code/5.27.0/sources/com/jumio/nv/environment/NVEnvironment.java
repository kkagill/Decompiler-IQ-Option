...
public class NVEnvironment extends Environment {
    ...
    public static String getCardDetectionSettingsPath(Context context) {
        ...
        String str = ".xml";
        Environment.extractFile(context, NVEnvironment.class, "card_detector/card_detection_engine", "9ef87da4d5737222a284baa8fdbe72c2805334b85a779fb3a5f68cc18420bc3f", str);
        Environment.extractFile(context, NVEnvironment.class, "card_detector/fast_findcard_config", "839c941a7446898b3f2e655850e65d60d8e70d72ac394c36b4b4bf9093042682", str);
