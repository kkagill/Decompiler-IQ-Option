...
public class TemplateMatcherFrameIndicator extends View {
    ...
    private void a() {
        ...
        String str = "x";
        PropertyValuesHolder ofFloat = PropertyValuesHolder.ofFloat(str, new float[]{this.d.x, this.e.x});
        String str2 = "y";
        PropertyValuesHolder ofFloat2 = PropertyValuesHolder.ofFloat(str2, new float[]{this.d.y, this.e.y});
        ...
        ofFloat2 = PropertyValuesHolder.ofFloat(str, new float[]{this.f.x, this.g.x});
        PropertyValuesHolder ofFloat3 = PropertyValuesHolder.ofFloat(str2, new float[]{this.f.y, this.g.y});
        ...
        ofFloat3 = PropertyValuesHolder.ofFloat(str, new float[]{this.h.x, this.i.x});
        PropertyValuesHolder ofFloat4 = PropertyValuesHolder.ofFloat(str2, new float[]{this.h.y, this.i.y});
        ...
        PropertyValuesHolder ofFloat5 = PropertyValuesHolder.ofFloat(str, new float[]{this.j.x, this.k.x});
        PropertyValuesHolder ofFloat6 = PropertyValuesHolder.ofFloat(str2, new float[]{this.j.y, this.k.y});
        ObjectAnimator.ofPropertyValuesHolder(this.j, new PropertyValuesHolder[]{ofFloat5, ofFloat6}).addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                TemplateMatcherFrameIndicator.this.postInvalidate();
            }
        });
        animatorSet.playTogether(new Animator[]{ofPropertyValuesHolder, ofPropertyValuesHolder2, ofPropertyValuesHolder3, r3});
