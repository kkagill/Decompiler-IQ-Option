...
public class jniInterfaceJNI {
    ...
    public static final native int OcrCardTypeAtmCard_get();
    ...
    public static final native int OcrCardTypeCabal_get();

    public static final native int OcrCardTypeCarnet_get();

    public static final native int OcrCardTypeChinaUnionPay_get();

    public static final native int OcrCardTypeChjonesFuelCard_get();

    public static final native int OcrCardTypeCirrus_get();

    public static final native int OcrCardTypeComprocard_get();

    public static final native int OcrCardTypeDankort_get();

    public static final native int OcrCardTypeDinacard_get();
    ...
    public static final native int OcrCardTypeDuet_get();

    public static final native int OcrCardTypeEftpos_get();

    public static final native int OcrCardTypeElo_get();

    public static final native int OcrCardTypeEuroshellFuelCard_get();

    public static final native int OcrCardTypeFuelCard_get();
    ...
    public static final native int OcrCardTypeHrgStoreCard_get();

    public static final native int OcrCardTypeJcb_get();

    public static final native int OcrCardTypeLocalBrand_get();

    public static final native int OcrCardTypeLocalCard_get();
    ...
    public static final native int OcrCardTypeNewday_get();

    public static final native int OcrCardTypeNspkMir_get();

    public static final native int OcrCardTypeOurocard_get();

    public static final native int OcrCardTypePhhFuelCard_get();

    public static final native int OcrCardTypePrivateLabel_get();
    ...
    public static final native int OcrCardTypeSbercard_get();
    ...
    public static final native int OcrCardTypeUatp_get();
    ...
    public static final native int OcrCardTypeVpay_get();
    ...
    public static final native long OcrEngineSession_SWIGSmartPtrUpcast(long j);
    ...
    public static final native String OcrException_what(long j, OcrException ocrException);
    ...
    public static final native void delete_OcrException(long j);
    ...
    public static final native long new_OcrEngineInternalSettings();
    ...
    public static final native long new_OcrException(String str);
