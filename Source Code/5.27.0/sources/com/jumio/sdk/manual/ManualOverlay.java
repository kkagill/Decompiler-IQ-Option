...
public class ManualOverlay implements Overlay {
    ...
    public void prepareDraw(ScanSide scanSide, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            imageView = this.mShutterButton;
            imageView.setTranslationY((float) ((this.height - imageView.getHeight()) - dipToPx));
            return;
        }
        layoutParams.addRule(14, 0);
        layoutParams.addRule(15, 1);
        imageView = this.mShutterButton;
        imageView.setTranslationX((float) ((this.width - imageView.getWidth()) - dipToPx));
