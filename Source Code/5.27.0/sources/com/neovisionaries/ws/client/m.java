...
class m {
    ...
    L_0x006a:
        goto L_0x0069;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.neovisionaries.ws.client.m.b(com.neovisionaries.ws.client.ak):java.util.Map");
    }
    ...
    private void a(ad adVar, Map<String, List<String>> map, String str) {
        ...
        if (list != null) {
            ...
            try {
                if (!b.encode(MessageDigest.getInstance("SHA-1").digest(p.kx(stringBuilder.toString()))).equals(str2)) {
