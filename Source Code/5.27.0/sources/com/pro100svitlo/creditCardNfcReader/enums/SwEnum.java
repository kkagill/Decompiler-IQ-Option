...
public enum SwEnum {
    ...
    private SwEnum(String str, String str2) {
        this.status = a.kX(str);
        this.detail = str2;
    }
    ...
    public static SwEnum getSW(byte[] bArr) {
        if (bArr != null && bArr.length >= 2) {
            for (SwEnum swEnum : values()) {
                ...
                byte[] bArr3 = swEnum.status;
                if (b == bArr3[0] && bArr[bArr.length - 1] == bArr3[1]) {
                    return swEnum;
                }
            }
        }
