...
public class Service extends AbstractData {
    ...
    public Service(String str) {
        if (str != null && str.length() == 3) {
            a aVar = new a(com.pro100svitlo.creditCardNfcReader.a.a.kX(c.f(str, 4, "0")));
            this.serviceCode1 = (ServiceCode1Enum) com.pro100svitlo.creditCardNfcReader.a.c.a(aVar.jc(4), ServiceCode1Enum.class);
            this.serviceCode2 = (ServiceCode2Enum) com.pro100svitlo.creditCardNfcReader.a.c.a(aVar.jc(4), ServiceCode2Enum.class);
            this.serviceCode3 = (ServiceCode3Enum) com.pro100svitlo.creditCardNfcReader.a.c.a(aVar.jc(4), ServiceCode3Enum.class);
        }
    }
}
