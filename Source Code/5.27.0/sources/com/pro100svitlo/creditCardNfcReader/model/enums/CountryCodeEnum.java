...
public enum CountryCodeEnum implements a {
    ...
    ER("Eritrea", "ERI", 232),
    ES("Spain", "ESP", 724),
    ET("Ethiopia", Currencies.ETH_CURRENCY, 231),
    FI("Finland", "FIN", 246),
    FJ("Fiji", "FJI", 242),
    FK("Falkland Islands", "FLK", 238),
    FM("Federated States of Micronesia", "FSM", 583),
    FO("Faroe Islands", "FRO", 234),
    FR("France", "FRA", Callback.DEFAULT_SWIPE_ANIMATION_DURATION),
    GA("Gabon", "GAB", 266),
    ...
    GL("Greenland", "GRL", MobileEvents.EVENTTYPE_RAW_TOUCH),
    GM("Gambia", "GMB", 270),
    GN("Guinea", "GIN", 324),
    GP("Guadeloupe", "GLP", MobileEvents.EVENTTYPE_LIFENESS_INFO),
    ...
    JO("Jordan", "JOR", 400),
    JP("Japan", "JPN", 392),
    KE("Kenya", "KEN", WalletConstants.ERROR_CODE_INVALID_PARAMETERS),
    ...
    KR("Republic of Korea", "KOR", WalletConstants.ERROR_CODE_INVALID_TRANSACTION),
    KW("Kuwait", "KWT", 414),
    ...
    private CountryCodeEnum(String str, String str2, int i) {
        this.name = str;
        this.alpha3 = str2;
        this.numeric = i;
    }
