...
final class Utils {
    ...
    static void log(String str, String str2, String str3, String str4) {
        Object[] objArr = new Object[]{str, str2, str3, str4};
    ...
    /* JADX WARNING: Missing block: B:4:?, code skipped:
            ...
            r1 = com.squareup.picasso.Utils.OkHttpDownloaderCreator.create(r1);
     */
    ...
    static com.squareup.picasso.Downloader createDefaultDownloader(android.content.Context r1) {
        ...
        r1 = com.squareup.picasso.Utils.OkHttp3DownloaderCreator.create(r1);	 Catch:{ ClassNotFoundException -> 0x000a }
        return r1;
    L_0x000a:
        r0 = "com.squareup.okhttp.OkHttpClient";
        java.lang.Class.forName(r0);	 Catch:{ ClassNotFoundException -> 0x0014 }
        r1 = com.squareup.picasso.Utils.OkHttpDownloaderCreator.create(r1);	 Catch:{ ClassNotFoundException -> 0x0014 }
        return r1;
    L_0x0014:
    ...
    static int calculateMemoryCacheSize(Context context) {
        ...
        return (int) ((((long) (((context.getApplicationInfo().flags & 1048576) != 0 ? 1 : null) != null ? activityManager.getLargeMemoryClass() : activityManager.getMemoryClass())) * 1048576) / 7);
    }
    ...
    static boolean isWebPFile(InputStream inputStream) {
        ...
        String str = "US-ASCII";
        if (!WEBP_FILE_HEADER_RIFF.equals(new String(bArr, 0, 4, str))) {
            return false;
        }
        if (WEBP_FILE_HEADER_WEBP.equals(new String(bArr, 8, 4, str))) {
            return true;
        }
        return false;
    }
