...
/* compiled from: LocalizedStringsES_MX */
public class h implements c<StringKey> {
    ...
    public h() {
        ...
        eLx.put(StringKey.ERROR_CAMERA_UNEXPECTED_FAIL, "El dispositivo tuvo un error inesperado al abrir la cámara.");
    }
}
