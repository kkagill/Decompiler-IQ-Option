...
class g {
    final KeyStore eOS;
    private final HashMap<Principal, X509Certificate> eOT;

    public g(InputStream inputStream, String str) {
        KeyStore e = e(inputStream, str);
        this.eOT = a(e);
        this.eOS = e;
    }

    public boolean c(X509Certificate x509Certificate) {
        X509Certificate x509Certificate2 = (X509Certificate) this.eOT.get(x509Certificate.getSubjectX500Principal());
    ...
    public X509Certificate d(X509Certificate x509Certificate) {
        X509Certificate x509Certificate2 = (X509Certificate) this.eOT.get(x509Certificate.getIssuerX500Principal());
    ...
    private KeyStore e(InputStream inputStream, String str) {
