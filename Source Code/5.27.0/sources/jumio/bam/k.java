...
public class k extends n {
    ...
    public k(Context context, int i) {
        ...
        editText.setPadding(editText.getPaddingLeft(), ScreenUtil.dpToPx(context, 2), this.d.getRight(), this.d.getPaddingBottom());
        a(false);
    ...
    public boolean a() {
        ...
        Matcher matcher = pattern.matcher(this.d.getText());
        if (this.b) {
            a(1 ^ matcher.matches());
        }
