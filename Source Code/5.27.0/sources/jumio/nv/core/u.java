...
public class u extends BaseAdapter implements ListAdapter, SectionIndexer {
    ...
    private void b(String str) {
        ...
        if (str != null && this.d != null) {
            ...
            for (Country country : this.d) {
                if (country.getName().toUpperCase(locale).contains(str)) {
                    this.c.add(country);
                }
            }
        }
    ...
    private void a() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int compareToIgnoreCase = substring.compareToIgnoreCase("Ä");
            String str = ActiveQuote.PHASE_CLOSING_AUCTION;
            if (compareToIgnoreCase == 0 || substring.compareToIgnoreCase("Å") == 0) {
                substring = str;
            } else if (substring.compareToIgnoreCase("Ü") == 0) {
                substring = ActiveQuote.PHASE_UNKNOWN;
    ...
    private int c(String str) {
        ...
        for (int i2 = 0; i2 < this.a.size(); i2++) {
            SparseArray sparseArray = this.a;
            if (((String) sparseArray.get(sparseArray.keyAt(i2))).equals(str)) {
                i = i2;
            }
        }
        return i;
