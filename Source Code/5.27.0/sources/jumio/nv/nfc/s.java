...
public class s extends i {
    ...
    public s(r rVar, d dVar, String str, Date date, Date date2, String str2) {
        super(dVar, str, date, date2, str2);
        this.b = rVar;
    }
    ...
    @NonNull
    public o g() {
        return this.b.containsKey(p.ADDITIONAL_DATA) ? this.b.get(p.ADDITIONAL_DATA) : super.g();
    }
