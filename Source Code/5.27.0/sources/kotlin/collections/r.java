...
class r extends q {
    ...
    public static final <T> boolean a(Iterable<? extends T> iterable, b<? super T, Boolean> bVar) {
        kotlin.jvm.internal.i.f(iterable, "$this$retainAll");
        kotlin.jvm.internal.i.f(bVar, "predicate");
        return a((Iterable) iterable, (b) bVar, false);
    }
    ...
    public static final <T> boolean b(List<T> list, b<? super T, Boolean> bVar) {
        kotlin.jvm.internal.i.f(list, "$this$removeAll");
        kotlin.jvm.internal.i.f(bVar, "predicate");
        return a((List) list, (b) bVar, true);
    }

    private static final <T> boolean a(List<T> list, b<? super T, Boolean> bVar, boolean z) {
