...
public final class a {
    ...
    public static final long a(InputStream inputStream, OutputStream outputStream, int i) {
        kotlin.jvm.internal.i.f(inputStream, "$this$copyTo");
    ...
    public static final byte[] b(InputStream inputStream) {
        kotlin.jvm.internal.i.f(inputStream, "$this$readBytes");
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(Math.max(8192, inputStream.available()));
        a(inputStream, byteArrayOutputStream, 0, 2, null);
        byte[] toByteArray = byteArrayOutputStream.toByteArray();
        kotlin.jvm.internal.i.e(toByteArray, "buffer.toByteArray()");
        return toByteArray;
    }
}
