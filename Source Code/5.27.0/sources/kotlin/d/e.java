...
class e extends d {
        ...
        try {
            ...
            if (length <= ((long) Integer.MAX_VALUE)) {
                ...
                if (i2 != 0) {
                    ...
                    kotlin.jvm.internal.i.e(bArr, "java.util.Arrays.copyOf(this, newSize)");
                }
    ...
    public static final void a(java.io.File r2, byte[] r3) {
        ...
        r3 = kotlin.l.eVB;	 Catch:{ Throwable -> 0x0022 }
        kotlin.d.b.a(r0, r2);
        return;
    L_0x0020:
        r3 = move-exception;
    ...
    L_0x0024:
        ...
        throw r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.d.e.a(java.io.File, byte[]):void");
    }

    public static final String a(File file, Charset charset) {
        kotlin.jvm.internal.i.f(file, "$this$readText");
    ...
    public static final void a(File file, String str, Charset charset) {
        kotlin.jvm.internal.i.f(file, "$this$writeText");
