...
public enum KotlinTarget {
    ...
    static {
        ...
        DEFAULT_TARGET_SET = u.V((List) arrayList);
        ALL_TARGET_SET = i.G(values());
        USE_SITE_MAPPING = af.a(j.x(AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER, VALUE_PARAMETER), j.x(AnnotationUseSiteTarget.FIELD, FIELD), j.x(AnnotationUseSiteTarget.PROPERTY, PROPERTY), j.x(AnnotationUseSiteTarget.FILE, FILE), j.x(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), j.x(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), j.x(AnnotationUseSiteTarget.RECEIVER, VALUE_PARAMETER), j.x(AnnotationUseSiteTarget.SETTER_PARAMETER, VALUE_PARAMETER), j.x(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, FIELD));
    }
}
