...
final class Jsr305State$description$2 extends Lambda implements a<String[]> {
    ...
    public final String[] invoke() {
        ...
        arrayList.add(this.this$0.bPZ().getDescription());
        ReportLevel bQa = this.this$0.bQa();
        if (bQa != null) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("under-migration:");
            stringBuilder.append(bQa.getDescription());
            arrayList.add(stringBuilder.toString());
        }
        for (Entry entry : this.this$0.bQb().entrySet()) {
