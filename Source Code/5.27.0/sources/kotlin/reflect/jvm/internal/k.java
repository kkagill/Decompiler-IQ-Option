...
public final class k<T, R> extends p<T, R> implements h<T, R> {
    ...
    public k(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, Object obj) {
        ...
        b d = x.d(new KMutableProperty1Impl$_setter$1(this));
        kotlin.jvm.internal.i.e(d, "ReflectProperties.lazy { Setter(this) }");
        this.eXD = d;
    }

    public k(KDeclarationContainerImpl kDeclarationContainerImpl, ae aeVar) {
        kotlin.jvm.internal.i.f(kDeclarationContainerImpl, "container");
