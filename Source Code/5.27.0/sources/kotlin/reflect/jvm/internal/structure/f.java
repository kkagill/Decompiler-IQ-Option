...
public interface f extends d {
    ...
    public static final class a {
        ...
        public static List<c> a(f fVar) {
            AnnotatedElement bQn = fVar.bQn();
            if (bQn != null) {
                Annotation[] declaredAnnotations = bQn.getDeclaredAnnotations();
