...
class AndroidPlatform extends Platform {
    ...
    public boolean isCleartextTrafficPermitted(String str) {
        try {
            ...
            str = api24IsCleartextTrafficPermitted(str, cls, cls.getMethod("getInstance", new Class[0]).invoke(null, new Object[0]));
            return str;
    ...
    private boolean api24IsCleartextTrafficPermitted(String str, Class<?> cls, Object obj) {
        try {
            str = ((Boolean) cls.getMethod("isCleartextTrafficPermitted", new Class[]{String.class}).invoke(obj, new Object[]{str})).booleanValue();
            return str;
    ...
    private boolean api23IsCleartextTrafficPermitted(String str, Class<?> cls, Object obj) {
        try {
            str = ((Boolean) cls.getMethod("isCleartextTrafficPermitted", new Class[0]).invoke(obj, new Object[0])).booleanValue();
            return str;
        } catch (NoSuchMethodException unused) {
            return super.isCleartextTrafficPermitted(str);
        }
    ...
    public javax.net.ssl.SSLContext getSSLContext() {
        ...
        r3 = this;
        r0 = 1;
        r1 = android.os.Build.VERSION.SDK_INT;	 Catch:{ NoClassDefFoundError -> 0x000f }
        r2 = 16;
    ...
    L_0x0018:
        r0 = "TLS";
        r0 = javax.net.ssl.SSLContext.getInstance(r0);	 Catch:{ NoSuchAlgorithmException -> 0x001f }
        return r0;
    L_0x001f:
        r0 = move-exception;
