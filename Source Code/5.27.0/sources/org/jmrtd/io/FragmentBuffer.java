...
public class FragmentBuffer implements Serializable {
    ...
    public static class Fragment implements Serializable {
        ...
        public static Fragment bp(int i, int i2) {
    ...
    public synchronized void f(int i, byte[] bArr, int i2, int i3) {
        ...
        this.fragments.add(Fragment.bp(i, i3));
    }

    public synchronized boolean mO(int i) {
        return bn(i, 1);
    }

    public synchronized boolean bn(int i, int i2) {
    ...
    public synchronized int mP(int i) {
        int i2 = 0;
    ...
    public synchronized Fragment bo(int i, int i2) {
        int i3;
        i3 = i2;
        i2 = i;
        for (Fragment fragment : this.fragments) {
    ...
    /* JADX WARNING: Missing block: B:49:0x0059, code skipped:
            return r0;
     */
